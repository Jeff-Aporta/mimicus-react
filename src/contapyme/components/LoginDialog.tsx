/**
 * LoginDialog — isla: contapyme
 * repo: Jeff-Aporta/mimicus-react · src/contapyme/components/LoginDialog.tsx
 * Diálogo modal (<dialog>) para el formulario de login ContaPyme.
 */
...
export function LoginDialog({ open, busy, title = "Iniciar sesión", icon = "mdi:account-key-outline", onClose, children, footer }: LoginDialogProps) {
