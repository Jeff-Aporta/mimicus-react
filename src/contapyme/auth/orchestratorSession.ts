// @ts-nocheck — API del orquestador ContaPyme con respuestas heterogéneas (terceros/sesión/multiempresa); tipado estricto fuera de alcance.
import { AUTH_DEFAULTS, MAIN_ORCHESTRATOR_LS_KEY } from "../constants.ts";
