...
export type CdnImports = Record<string, string> | ((base: string) => Record<string, string>);
export type CdnPack =
  | { kind: "html"; html: string }
  | { kind: "importmap"; imports: CdnImports }
  | { kind: "link-css"; href: string | ((base: string) => string); attrs?: Record<string, string> }
  | { kind: "script-src"; src: string | ((base: string) => string); defer?: boolean; attrs?: Record<string, string> };

export const CDN_PACKS: Record<string, CdnPack> = {
  "preconnect-jsdelivr": {
    kind: "html",
 ...
 */
export const CDN_GROUPS: Record<string, string[]> = {
