 ...
 * repo: Jeff-Aporta/mimicus-react · src/layout/grid/GridLayout.tsx
...
import { dataDebug, getScrollbarClass, joinStyle, resolveGap, resolveGridTemplate, resolveJustify } from "../shared/layoutHelpers.ts";

export interface GridLayoutProps extends Omit<HTMLAttributes<HTMLDivElement>, "color"> {
  cells?: string | number;
  cellsFit?: boolean;
