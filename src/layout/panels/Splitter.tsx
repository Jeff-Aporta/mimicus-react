 ...
 * repo: Jeff-Aporta/mimicus-react · src/layout/panels/Splitter.tsx
...
import { subscribeNarrowViewport } from "../shared/layoutBreakpoints.ts";
import { clampSplitterSize, readSplitterStorage, writeSplitterStorage } from "./splitterResize.ts";

export interface SplitterProps extends Omit<HTMLAttributes<HTMLDivElement>, "color"> {
...
export function Splitter({
  ...
  const panelStyle: CSSProperties = resizeAlongX
