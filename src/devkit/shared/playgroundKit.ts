 ...
 * repo: Jeff-Aporta/mimicus-react · src/devkit/shared/playgroundKit.ts
...
export const VARIANT_ICONS = {
  solid: "mdi:checkbox-blank-circle", outlined: "mdi:checkbox-blank-circle-outline", ghost: "mdi:ghost-outline",
  soft: "mdi:blur", text: "mdi:format-text", glass: "mdi:shimmer", dashed: "mdi:vector-square", flat: "mdi:card-outline",
};
export const SHAPE_ICONS = {
  round: "mdi:rounded-corner", rect: "mdi:square-outline", square: "mdi:square-outline", pill: "mdi:pill", circle: "mdi:circle-outline",
};
export const TYPE_ICONS = { button: "mdi:gesture-tap", submit: "mdi:form-select", reset: "mdi:restore" };
export const PLACEMENT_ICONS = { start: "mdi:arrow-left", end: "mdi:arrow-right", top: "mdi:arrow-up", bottom: "mdi:arrow-down", left: "mdi:arrow-left", right: "mdi:arrow-right" };

/** Icono representativo por defecto para una opción, según la semántica del campo. */
export function defaultOptionIcon(fieldKey, value) {
