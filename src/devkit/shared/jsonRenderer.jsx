 ...
 * repo: Jeff-Aporta/mimicus-react · src/devkit/shared/jsonRenderer.jsx
 * Renderiza árboles de nodos JSON (stack, repeat, demo-component, catalog-categories…) a React.
 */
import { Card } from "../_ui.js";
import { Button } from "../_ui.js";
import { getDemoIcon, ReviewStatusDot, statusDotsFor, statusFor } from "../catalog/catalogUi.jsx";
import { Icon } from "../../components/Icon.jsx";
import { SidePanelSection, sectionColorFor, sortedCategories, sectionMeta } from "../_ui.js";
import { LAYOUT_PREVIEW_EMOJIS, parseStyleString } from "./playgroundKit.js";
import { buildDemoComponentProps, previewBuiltins } from "./driver/previewBuiltins.jsx";
