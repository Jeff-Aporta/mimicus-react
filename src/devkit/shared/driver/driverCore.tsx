 ...
 * repo: Jeff-Aporta/mimicus-react · src/devkit/shared/driver/driverCore.tsx
 * Núcleo del driver de demos: adaptador JSON→controlador (JsonDemoAdapter) y componente DemoPage.
 */
import { useMemo, useState } from "react";
import { AccordionDemo, DemoController } from "../demo-shell/demoShellUi.tsx";
import { hydrateFields } from "./fieldHydration.ts";
import { buildCodeFromStrategy } from "./codeStrategies.ts";
import { PreviewRenderer } from "./previewRenderer.tsx";

export { stateForPreview } from "./previewBuiltins.tsx";
export { resolveComponent, isStubComponent } from "./componentRegistry.tsx";
