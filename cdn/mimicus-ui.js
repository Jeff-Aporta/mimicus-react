...
(() => {
  ...
  function Button({
    ...
    const content = /* @__PURE__ */ React.createElement(React.Fragment, null, (icon || isLoading) && (isLoading ? /* @__PURE__ */ React.createElement("span", { className: "mimicus-text-icon", "aria-hidden": true }, "\u2026") : icon), children != null && /* @__PURE__ */ React.createElement("span", { className: "button-content" }, children));
    if (wrap) {
  ...
  function AppLayoutSider({
    ...
    return /* @__PURE__ */ React.createElement("aside", { ...rest, className: rootClass, style: mergedStyle }, /* @__PURE__ */ React.createElement("div", { className: "mimicus-app-layout-sider__body" }, children), collapsible && /* @__PURE__ */ React.createElement("div", { className: "mimicus-app-layout-sider__trigger" }, /* @__PURE__ */ React.createElement(Button, { variant: "text", color: isDark ? "neutral" : "primary", onClick: toggle, style: { width: "100%", justifyContent: "center", color: "inherit" } }, collapsed ? "\u203A" : "\u2039")));
  }
