...
function AvatarGroup({ max = 5, total, spacing = "medium", children, className, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs8("span", { ...rest, className: cx("mimicus-avatar-group", `mimicus-avatar-group--${spacing}`, className), style, children: [
    shown,
    surplus > 0 && /* @__PURE__ */ jsxs8(Avatar, { size: "medium", className: "mimicus-avatar-group__surplus", children: [
      "+",
      surplus
    ] })
  ] });
...
function Table({ columns = [], dataSource = [], bordered, size = "medium", sortable, pagination, className, style, children, ...rest }) {
  ...
  if (children) {
    return /* @__PURE__ */ jsx12("table", { ...rest, ref, className: cx("mimicus-table", bordered && "mimicus-table--bordered", `mimicus-table--${size}`, className), style, "data-mimicus-display": sortable ? "table" : void 0, children });
  }
  return /* @__PURE__ */ jsxs8("table", { ...rest, ref, className: cx("mimicus-table", bordered && "mimicus-table--bordered", `mimicus-table--${size}`, className), style, "data-mimicus-display": sortable ? "table" : void 0, children: [
...
function Icon({ icon, className, style }) {
  if (!icon) return null;
  return /* @__PURE__ */ jsx21("iconify-icon", { icon, className, style: style && typeof style === "object" ? style : void 0 });
}

// src/components/FloatButton.tsx
import { Children as Children8, useEffect as useEffect5, useState as useState5 } from "react";
...
function CodeBlock({
  ...
  const cmRef = useRef4(null);
  const onChangeRef = useRef4(onChange);
  const syncingRef = useRef4(false);
  ...
  if (!cmReady) {
    return /* @__PURE__ */ jsxs12("div", { className: panelClass, style, children: [
      /* @__PURE__ */ jsx24("div", { className: "mimicus-cm-panel__toolbar", children: /* @__PURE__ */ jsx24(IconButton, { size: "small", "aria-label": copyTitle, onClick: () => copyEditorText(value), title: copyTitle, children: "\u29C9" }) }),
      /* @__PURE__ */ jsx24("pre", { className: "mimicus-cm-fallback", style: hostStyle, children: value || placeholder })
    ] });
  }
  return /* @__PURE__ */ jsxs12("div", { className: panelClass, style, children: [
    /* @__PURE__ */ jsx24("div", { className: "mimicus-cm-panel__toolbar", children: /* @__PURE__ */ jsx24(IconButton, { size: "small", className: "mimicus-cm-panel__copy", "aria-label": copyTitle, title: copied ? "Copiado" : copyTitle, onClick: handleCopy, children: copied ? "\u2713" : "\u29C9" }) }),
...
import { Children as Children9, useEffect as useEffect8, useMemo as useMemo3, useRef as useRef5 } from "react";
...
import { Children as Children10, useId as useId2, useRef as useRef6, useState as useState7 } from "react";
...
function Input({
  ...
  return /* @__PURE__ */ jsxs15("span", { className: cx4("mimicus-input", `mimicus-input--${size}`, status && `is-${status}`, disabled && "is-disabled", className), style, children: [
...
function Checkbox({
  ...
  const id = useId2();
  return /* @__PURE__ */ jsxs15("label", { className: cx4("mimicus-checkbox", `mimicus-checkbox--${size}`, on2 && "is-checked", indeterminate && "is-indeterminate", disabled && "is-disabled", loading && "is-loading", className), style, children: [
    /* @__PURE__ */ jsx27(
      "input",
      {
        ...rest,
    ...
    Checkbox,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs15("span", { className: "mimicus-checkbox__icons", children: [
          /* @__PURE__ */ jsx27("span", { className: "mimicus-checkbox__icon mimicus-checkbox__icon--on", children: iconChecked ?? icon ?? "\u2713" }),
          /* @__PURE__ */ jsx27("span", { className: "mimicus-checkbox__icon mimicus-checkbox__icon--off", children: iconUnchecked ?? "\u25CB" })
        ] }),
        children
      ]
    }
...
function Switch({ checked, defaultChecked = false, onChange, disabled, loading, size = "medium", children, className, style, ...rest }) {
  const [on2, set] = useCtrl(checked, defaultChecked, onChange);
  return /* @__PURE__ */ jsxs15("label", { className: cx4("mimicus-switch", `mimicus-switch--${size}`, on2 && "is-checked", disabled && "is-disabled", loading && "is-loading", className), style, children: [
    /* @__PURE__ */ jsx27(
      "input",
      {
        ...rest,
    ...
    /* @__PURE__ */ jsx27("span", { className: "mimicus-switch__track", children: /* @__PURE__ */ jsx27("span", { className: "mimicus-switch__thumb" }) }),
...
import { useCallback, useEffect as useEffect13, useLayoutEffect, useMemo as useMemo5, useRef as useRef11, useState as useState9 } from "react";
...
import { useEffect as useEffect10, useRef as useRef7, useSyncExternalStore } from "react";
...
registerCellRenderer("boolean", ({ value }) => /* @__PURE__ */ jsx29(Icon, { icon: value ? "mdi:check-circle" : "mdi:close-circle-outline", className: value ? "mim-dg-bool mim-dg-bool--on" : "mim-dg-bool mim-dg-bool--off" }));
...
function GridBody(props) {
  ...
  return /* @__PURE__ */ jsx31("div", { className: "mim-dg__body", style: { height: totalHeight, width: totalWidth }, role: "rowgroup", children: /* @__PURE__ */ jsx31("div", { className: "mim-dg__rows", style: { transform: `translateY(${topPad}px)` }, children: rows.map((node) => {
...
function HeaderMenu(props) {
  ...
  return /* @__PURE__ */ jsxs20("div", { ref, className: "mim-dg__menu pg-scrollbar", style: { left: x, top: y }, role: "menu", children: [
    column.sortable && /* @__PURE__ */ jsxs20(Fragment6, { children: [
      /* @__PURE__ */ jsxs20("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onSort(column.colId, "asc")), children: [
        /* @__PURE__ */ jsx34(Icon, { icon: "mdi:sort-ascending" }),
        "Ordenar ascendente"
      ] }),
      /* @__PURE__ */ jsxs20("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onSort(column.colId, "desc")), children: [
        /* @__PURE__ */ jsx34(Icon, { icon: "mdi:sort-descending" }),
        "Ordenar descendente"
      ] }),
      /* @__PURE__ */ jsxs20("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onSort(column.colId, null)), children: [
        /* @__PURE__ */ jsx34(Icon, { icon: "mdi:sort-variant-remove" }),
        "Quitar orden"
      ] }),
      /* @__PURE__ */ jsx34("div", { className: "mim-dg__menu-sep" })
    ] }),
    column.filterType && /* @__PURE__ */ jsxs20(Fragment6, { children: [
      /* @__PURE__ */ jsxs20("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onFilter(column)), children: [
        /* @__PURE__ */ jsx34(Icon, { icon: "mdi:filter-outline" }),
        "Filtrar\u2026"
      ] }),
      /* @__PURE__ */ jsx34("div", { className: "mim-dg__menu-sep" })
    ] }),
    /* @__PURE__ */ jsxs20("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onPin(column.colId, "left")), children: [
      /* @__PURE__ */ jsx34(Icon, { icon: "mdi:pin" }),
      "Fijar a la izquierda"
    ] }),
    /* @__PURE__ */ jsxs20("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onPin(column.colId, "right")), children: [
      /* @__PURE__ */ jsx34(Icon, { icon: "mdi:pin" }),
      "Fijar a la derecha"
    ] }),
    /* @__PURE__ */ jsxs20("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onPin(column.colId, null)), children: [
      /* @__PURE__ */ jsx34(Icon, { icon: "mdi:pin-off-outline" }),
      "No fijar"
    ] }),
    /* @__PURE__ */ jsx34("div", { className: "mim-dg__menu-sep" }),
    /* @__PURE__ */ jsxs20("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onAutosize(column.colId)), children: [
      /* @__PURE__ */ jsx34(Icon, { icon: "mdi:arrow-expand-horizontal" }),
      "Autoajustar ancho"
    ] }),
    /* @__PURE__ */ jsxs20("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onHide(column.colId)), children: [
      /* @__PURE__ */ jsx34(Icon, { icon: "mdi:eye-off-outline" }),
      "Ocultar columna"
    ] })
  ] });
}
...
import { useEffect as useEffect12, useMemo as useMemo4, useRef as useRef10, useState as useState8 } from "react";
import { Fragment as Fragment7, jsx as jsx35, jsxs as jsxs21 } from "react/jsx-runtime";
var TEXT_OPS = [
...
function FilterPopover(props) {
  ...
  const [textOp, setTextOp] = useState8(tf?.op ?? "contains");
  const [textVal, setTextVal] = useState8(tf?.value ?? "");
  const [numOp, setNumOp] = useState8(nf?.op ?? "eq");
  const [numVal, setNumVal] = useState8(nf?.value != null ? String(nf.value) : "");
  const [numTo, setNumTo] = useState8(nf?.to != null ? String(nf.to) : "");
  const [dateOp, setDateOp] = useState8(df?.op ?? "eq");
  const [dateVal, setDateVal] = useState8(df?.value ?? "");
  const [dateTo, setDateTo] = useState8(df?.to ?? "");
  const [setSel, setSetSel] = useState8(new Set(sf?.values ?? uniqueValues2));
  const [setSearch, setSetSearch] = useState8("");
  ...
  return /* @__PURE__ */ jsxs21("div", { ref, className: "mim-dg__filter pg-scrollbar", style: { left: x, top: y }, role: "dialog", "aria-label": `Filtrar ${column.headerName}`, children: [
    type === "text" && /* @__PURE__ */ jsxs21(Fragment7, { children: [
      /* @__PURE__ */ jsx35("select", { className: "mim-dg__filter-field", value: textOp, onChange: (e) => setTextOp(e.target.value), children: TEXT_OPS.map((o) => /* @__PURE__ */ jsx35("option", { value: o.v, children: o.t }, o.v)) }),
      needsValue(textOp) && /* @__PURE__ */ jsx35("input", { className: "mim-dg__filter-field", placeholder: "Valor\u2026", autoFocus: true, value: textVal, onChange: (e) => setTextVal(e.target.value), onKeyDown: (e) => e.key === "Enter" && apply() })
    ] }),
    type === "number" && /* @__PURE__ */ jsxs21(Fragment7, { children: [
      /* @__PURE__ */ jsx35("select", { className: "mim-dg__filter-field", value: numOp, onChange: (e) => setNumOp(e.target.value), children: NUM_OPS.map((o) => /* @__PURE__ */ jsx35("option", { value: o.v, children: o.t }, o.v)) }),
      needsValue(numOp) && /* @__PURE__ */ jsx35("input", { type: "number", className: "mim-dg__filter-field", placeholder: "Valor\u2026", autoFocus: true, value: numVal, onChange: (e) => setNumVal(e.target.value), onKeyDown: (e) => e.key === "Enter" && apply() }),
      numOp === "inRange" && /* @__PURE__ */ jsx35("input", { type: "number", className: "mim-dg__filter-field", placeholder: "Hasta\u2026", value: numTo, onChange: (e) => setNumTo(e.target.value) })
    ] }),
    type === "date" && /* @__PURE__ */ jsxs21(Fragment7, { children: [
      /* @__PURE__ */ jsx35("select", { className: "mim-dg__filter-field", value: dateOp, onChange: (e) => setDateOp(e.target.value), children: DATE_OPS.map((o) => /* @__PURE__ */ jsx35("option", { value: o.v, children: o.t }, o.v)) }),
      /* @__PURE__ */ jsx35("input", { type: "date", className: "mim-dg__filter-field", value: dateVal, onChange: (e) => setDateVal(e.target.value) }),
      dateOp === "inRange" && /* @__PURE__ */ jsx35("input", { type: "date", className: "mim-dg__filter-field", value: dateTo, onChange: (e) => setDateTo(e.target.value) })
    ] }),
    type === "set" && /* @__PURE__ */ jsxs21(Fragment7, { children: [
      /* @__PURE__ */ jsx35("input", { className: "mim-dg__filter-field", placeholder: "Buscar valores\u2026", value: setSearch, onChange: (e) => setSetSearch(e.target.value) }),
      /* @__PURE__ */ jsxs21("div", { className: "mim-dg__filter-actions-row", children: [
        /* @__PURE__ */ jsx35("button", { type: "button", className: "mim-dg__filter-link", onClick: () => setSetSel(new Set(uniqueValues2)), children: "Todo" }),
        /* @__PURE__ */ jsx35("button", { type: "button", className: "mim-dg__filter-link", onClick: () => setSetSel(/* @__PURE__ */ new Set()), children: "Nada" })
      ] }),
      /* @__PURE__ */ jsx35("div", { className: "mim-dg__filter-set pg-scrollbar", children: shownVals.map((v) => /* @__PURE__ */ jsxs21("label", { className: "mim-dg__filter-set-item", children: [
        /* @__PURE__ */ jsx35("button", { type: "button", className: `mim-dg__checkbox mim-dg__checkbox--${setSel.has(v) ? "all" : "none"}`, onClick: () => toggleVal(v), children: /* @__PURE__ */ jsx35(Icon, { icon: setSel.has(v) ? "mdi:checkbox-marked" : "mdi:checkbox-blank-outline" }) }),
        /* @__PURE__ */ jsx35("span", { children: v || "(vac\xEDo)" })
      ] }, v)) })
    ] }),
    /* @__PURE__ */ jsxs21("div", { className: "mim-dg__filter-actions", children: [
      /* @__PURE__ */ jsx35("button", { type: "button", className: "mim-dg__tool-btn", onClick: clear, children: "Limpiar" }),
      /* @__PURE__ */ jsx35("button", { type: "button", className: "mim-dg__tool-btn is-primary", onClick: apply, children: "Aplicar" })
    ] })
  ] });
}
...
function DataGrid2(props) {
  ...
  const [density, setDensity] = useState9(props.density ?? "normal");
  ...
  const [filterPop, setFilterPop] = useState9(null);
  const [focusRow, setFocusRow] = useState9(-1);
  const lastRangeFrom = useRef11(null);
  useLayoutEffect(() => {
  ...
  const orderedIds = useMemo5(() => dataRows.map((r) => r.id), [dataRows]);
  ...
  const onToggleAll = useCallback(() => emit2(headerCheckbox === "all" ? clearSelection() : selectAll(dataRows)), [emit2, headerCheckbox, dataRows]);
  ...
  return /* @__PURE__ */ jsxs22("div", { className: `mim-dg${className ? ` ${className}` : ""}`, "data-density": density, style: { height, ...style }, children: [
    toolbar && /* @__PURE__ */ jsx36(
      GridToolbar,
      {
    ...
    /* @__PURE__ */ jsxs22("div", { className: "mim-dg__viewport pg-scrollbar", ref: viewportRef, onScroll, onKeyDown, tabIndex: 0, role: "grid", "aria-rowcount": state2.totalRows, children: [
      /* @__PURE__ */ jsx36(
        GridHeader,
        {
          columns: flat,
    ...
    /* @__PURE__ */ jsx36(GridFooter, { page: state2.page, pageSize: state2.pageSize, totalRows: state2.totalRows, selectedCount: state2.selection.size, pagination, onPage }),
    menu && /* @__PURE__ */ jsx36(
      HeaderMenu,
      {
        column: menu.col,
...
// src/theme/ThemeProvider.tsx
function useTheme() {
  const [theme, setTheme] = useState10(() => getThemeState());
  useEffect14(() => {
...
function useLooknfeel() {
  const [look, setLook] = useState10(() => getLooknfeelState());
  useEffect14(() => {
...
import { createContext as createContext3, useContext as useContext3, useEffect as useEffect15, useMemo as useMemo6, useState as useState11 } from "react";
...
function SpaOutlet({ routes = {}, defaultRoute = "home", fallback = null }) {
  ...
  if (!Page) return null;
  return typeof Page === "function" ? /* @__PURE__ */ jsx37(Page, {}) : Page;
}
function SpaRouter({ routes, defaultRoute = "home", children }) {
  const [nav, setNav2] = useState11(() => urlState.get());
  useEffect15(() => {
  ...
  return /* @__PURE__ */ jsx37(SpaContext.Provider, { value, children });
}
...
function MimicusSidebar({ title, children, className, ...rest }) {
  return /* @__PURE__ */ jsxs23("nav", { ...rest, className: ["mimicus-sidebar", className].filter(Boolean).join(" "), children: [
    title != null && /* @__PURE__ */ jsx37("div", { className: "mimicus-sidebar-header pg-sidebar-header", children: title }),
    /* @__PURE__ */ jsx37("div", { className: "mimicus-sidebar-body pg-sidebar-body", children })
  ] });
}
...
import { useCallback as useCallback2, useEffect as useEffect17, useState as useState12 } from "react";
...
function ContapymeSessionProvider({ session, children }) {
  ...
  return /* @__PURE__ */ jsx38(ContapymeSessionContext.Provider, { value, children });
}
...
function LoginDialog({ open, busy, title = "Iniciar sesi\xF3n", icon = "mdi:account-key-outline", onClose, children, footer }) {
  ...
  return /* @__PURE__ */ jsx40("dialog", { ref, className: "mimicus-login-dialog isa-login-dialog", "aria-labelledby": "mimicus-login-dialog-title", children: /* @__PURE__ */ jsxs24("div", { className: "mimicus-login-dialog__card isa-login-card mimicus-glass-card", children: [
    /* @__PURE__ */ jsxs24("header", { className: "mimicus-login-dialog__header isa-login-header", children: [
      /* @__PURE__ */ jsx40("span", { className: "mimicus-login-dialog__icon-box", "aria-hidden": true, children: /* @__PURE__ */ jsx40(ContapymeIcon, { icon, size: 22 }) }),
      /* @__PURE__ */ jsxs24("div", { className: "mimicus-login-dialog__titles", children: [
        /* @__PURE__ */ jsx40("h2", { id: "mimicus-login-dialog-title", className: "mimicus-login-dialog__title", children: title }),
        /* @__PURE__ */ jsx40("p", { className: "mimicus-login-dialog__subtitle", children: "Use su usuario y contrase\xF1a de la organizaci\xF3n." })
      ] }),
      /* @__PURE__ */ jsx40("button", { type: "button", className: "mimicus-login-dialog__close", "aria-label": "Cerrar", disabled: busy, onClick: () => !busy && onClose?.(), children: "\xD7" })
    ] }),
    /* @__PURE__ */ jsx40("div", { className: "mimicus-login-dialog__body", children }),
    footer && /* @__PURE__ */ jsx40("footer", { className: "mimicus-login-dialog__footer", children: footer })
  ] }) });
}
...
function LoginFormFields({
  ...
  return /* @__PURE__ */ jsxs25(Stack, { spacing: "0.75rem", className: "mimicus-login-form", children: [
    err ? /* @__PURE__ */ jsx41("div", { className: "mimicus-login-form__alert", role: "alert", children: err }) : null,
    needsEmpresa ? /* @__PURE__ */ jsx41("div", { className: "mimicus-login-form__info", children: "Seleccione la empresa con la que desea ingresar." }) : null,
    /* @__PURE__ */ jsx41(FormItem, { label: "Usuario", help: CONTAPYME_LOGIN_ID_HELPER, children: /* @__PURE__ */ jsx41(
      Input,
      {
        value: user,
    ...
    /* @__PURE__ */ jsx41(FormItem, { label: "Contrase\xF1a", children: /* @__PURE__ */ jsx41(
      Input,
      {
        ...
        disabled: busy,
        suffix: showPasswordToggle ? /* @__PURE__ */ jsx41(
          Button,
          {
            type: "button",
            variant: "text",
            ...
            children: /* @__PURE__ */ jsx41(ContapymeIcon, { icon: showPass ? "mdi:eye-off-outline" : "mdi:eye-outline", size: 18 })
          }
        ) : null,
        onKeyDown: (e) => {
          if (e.key === "Enter" && onEnter) {
    ...
    needsEmpresa ? /* @__PURE__ */ jsx41(FormItem, { label: "Empresa", children: /* @__PURE__ */ jsx41(
      Select,
      {
    ...
    showRemember ? /* @__PURE__ */ jsx41(Checkbox, { checked: remember, onChange: setRemember, disabled: busy, children: LOGIN_REMEMBER_LABEL }) : null
  ] });
}
function LoginFormActions({ busy, canSubmit, onCancel, onSubmit, showCancel = true }) {
  return /* @__PURE__ */ jsxs25("div", { className: "mimicus-login-form__actions", children: [
    showCancel ? /* @__PURE__ */ jsx41(Button, { type: "button", variant: "text", color: "neutral", shape: "rect", disabled: busy, onClick: onCancel, style: { width: "auto" }, children: "Cancelar" }) : null,
    /* @__PURE__ */ jsx41(Button, { type: "button", variant: "solid", color: "primary", shape: "rect", disabled: busy || !canSubmit, loading: busy, onClick: onSubmit, style: { width: "auto" }, children: "Iniciar sesi\xF3n" })
  ] });
}
...
function LoginButton({
  ...
  const [openInternal, setOpenInternal] = useState12(false);
  const open = loginOpenProp != null ? loginOpenProp : openInternal;
  const setOpen = onLoginOpenChange || setOpenInternal;
  const [user, setUser] = useState12("");
  const [pass, setPass] = useState12("");
  const [remember, setRemember] = useState12(true);
  const [showPass, setShowPass] = useState12(false);
  const [err, setErr] = useState12("");
  const [busy, setBusy] = useState12(false);
  const [terceros, setTerceros] = useState12([]);
  const [selectedItercero, setSelectedItercero] = useState12("");
  ...
  if (logged?.username) {
    ...
    return /* @__PURE__ */ jsx42("span", { className: [wrapClass, "mimicus-login-button", "mimicus-login-button--session", className].filter(Boolean).join(" "), style, children: /* @__PURE__ */ jsx42(FlexLayout, { items: "center", gap: "0.35rem", className: btnClass, children: /* @__PURE__ */ jsx42(
      Dropdown,
      {
        placement: "bottomRight",
        trigger: /* @__PURE__ */ jsxs26(Button, { type: "button", variant: "soft", color: "primary", shape: "rect", className: "header-session-chip mimicus-login-button__chip", style: { width: "auto" }, children: [
          /* @__PURE__ */ jsx42(ContapymeIcon, { icon: "mdi:account-circle-outline", size: 18 }),
          /* @__PURE__ */ jsx42("span", { children: label })
        ] }),
        menu: /* @__PURE__ */ jsxs26(Menu, { children: [
          /* @__PURE__ */ jsxs26(Menu.Item, { disabled: true, children: [
            /* @__PURE__ */ jsx42("span", { className: "mimicus-login-button__menu-user", children: logged.username }),
            loggedAny.role ? /* @__PURE__ */ jsx42("span", { className: "mimicus-login-button__menu-role", children: loggedAny.role }) : null
          ] }),
          /* @__PURE__ */ jsx42(Menu.Divider, {}),
          /* @__PURE__ */ jsxs26(Menu.Item, { onClick: logout, children: [
            /* @__PURE__ */ jsx42(ContapymeIcon, { icon: "mdi:logout", size: 16 }),
            "Cerrar sesi\xF3n"
          ] })
        ] })
      }
  ...
  return /* @__PURE__ */ jsxs26("span", { className: [wrapClass, "mimicus-login-button", className].filter(Boolean).join(" "), style, children: [
    /* @__PURE__ */ jsx42(FlexLayout, { items: "center", gap: "0.35rem", className: btnClass, children: /* @__PURE__ */ jsxs26(Button, { type: "button", variant: "outlined", color: "neutral", shape: "rect", onClick: () => setOpen(true), style: { width: "auto" }, children: [
      /* @__PURE__ */ jsx42(ContapymeIcon, { icon: "mdi:login", size: 18 }),
      "Iniciar sesi\xF3n"
    ] }) }),
    /* @__PURE__ */ jsx42(
      LoginDialog,
...
function NavTabRow({ tabs = [], value, onChange, tier = "primary", className, tabHref }) {
  ...
  const scrollerRef = useRef13(null);
  useEffect18(() => {
  ...
  return /* @__PURE__ */ jsx43("div", { className: ["pg-nav-row", secondary ? "pg-nav-row--secondary" : "pg-nav-row--primary", className].filter(Boolean).join(" "), role: "tablist", children: /* @__PURE__ */ jsx43("div", { ref: scrollerRef, className: "pg-nav-row__scroller custom-scrollbar", children: tabs.map((tab) => {
    ...
    return /* @__PURE__ */ jsx43(
      Button,
      {
        ...
        onClick,
        onAuxClick: onClick,
        icon: tab.icon ? /* @__PURE__ */ jsx43("iconify-icon", { className: "pg-nav-tab__icon", icon: tab.disabled ? "mdi:lock-outline" : tab.icon, "aria-hidden": true }) : void 0,
        children: /* @__PURE__ */ jsx43("span", { className: "pg-nav-tab__label", children: label })
      },
      tab.id
    );
  }) }) });
...
import { Fragment as Fragment8, jsx as jsx44 } from "react/jsx-runtime";
function ShellHeaderNav({ shellConfig: shellConfig2, ctx, onTab, className }) {
  ...
  return /* @__PURE__ */ jsx44(Fragment8, { children: nav.rows.filter((row2) => row2.visible && row2.tabs.length > 0).map((row2) => /* @__PURE__ */ jsx44(NavTabRow, { tier: row2.tier, tabs: row2.tabs, value: row2.value, onChange: handleTab, className }, row2.id)) });
}

// src/devkit/Playground.tsx
import { useEffect as useEffect21, useMemo as useMemo13, useState as useState18 } from "react";
    ...
    /* @__PURE__ */ jsxs27("div", { className: "catalog-overview__main catalog-home", children: [
      showHero && /* @__PURE__ */ jsxs27("header", { className: "catalog-overview__hero pg-vt-hero", children: [
        ...
        /* @__PURE__ */ jsxs27("div", { className: "catalog-overview__toolbar", children: [
          /* @__PURE__ */ jsxs27("label", { className: "catalog-search", children: [
            /* @__PURE__ */ jsx45(Icon, { icon: "mdi:magnify", className: "catalog-search__icon" }),
            /* @__PURE__ */ jsx45("input", { type: "search", className: "catalog-search__input", placeholder: "Buscar componente\u2026", value: query, onChange: (e) => setQuery(e.target.value), "aria-label": "Buscar componente" })
          ] }),
...
function PaletteGrid({ label, labelIcon, value, onValueChange, options, name, columns, accent: accent2 = "primary", layout = "chips", getIcon }) {
  ...
  if (layout === "chips") {
    return /* @__PURE__ */ jsx46(InputDecorated, { label, icon: labelIcon, children: /* @__PURE__ */ jsx46("div", { className: "pg-palette-chips", style: { display: "flex", flexWrap: "wrap", gap: "0.35rem" }, children: items.map(([lbl, val]) => {
      const selected = String(value ?? "") === String(val ?? "");
      const icon = getIcon ? getIcon(val) : void 0;
      return /* @__PURE__ */ jsxs28(Button, { type: "button", variant: selected ? "soft" : "text", color: accent2 === "semantic" && val ? val : "primary", shape: "pill", onClick: () => onValueChange?.(val === "" ? void 0 : val), style: { fontSize: "0.78rem", paddingBlock: "0.2rem", paddingInline: "0.7rem", minHeight: "1.7rem" }, children: [
  ...
  return /* @__PURE__ */ jsx46(InputDecorated, { label, icon: labelIcon, children: /* @__PURE__ */ jsx46("div", { className: "pg-palette-grid", style: { display: "grid", gridTemplateColumns: `repeat(${cols}, minmax(0, 1fr))`, gap: "0.35rem", width: "100%" }, children: items.map(([lbl, val]) => {
    const selected = String(value ?? "") === String(val ?? "");
    return /* @__PURE__ */ jsxs28("label", { className: "pg-palette-grid__item", style: { display: "flex", alignItems: "center", gap: "0.35rem", cursor: "pointer" }, children: [
      /* @__PURE__ */ jsx46("input", { type: "radio", name: groupName, checked: selected, onChange: () => onValueChange?.(val === "" ? void 0 : val) }),
      /* @__PURE__ */ jsx46("span", { children: lbl || String(val ?? "Ninguno") })
    ] }, `${groupName}-${String(val)}`);
  }) }) });
}
...
function SwitchRow({ checked, label, onChange }) {
  return /* @__PURE__ */ jsx46(Switch, { className: "pg-switch-row", size: "small", checked: !!checked, onChange: (v) => onChange?.(v), children: label });
}
function ConfigRangeField({ value, min = 0, max = 100, step = 1, onChange }) {
  ...
  return /* @__PURE__ */ jsxs28("div", { className: "mimicus-slider pg-config-range", style: { width: "100%" }, children: [
    /* @__PURE__ */ jsx46("div", { className: "mimicus-slider__rail", children: /* @__PURE__ */ jsx46("div", { className: "mimicus-slider__fill", style: { width: `${pct}%` } }) }),
    /* @__PURE__ */ jsx46("input", { type: "range", className: "mimicus-slider__input", min, max, step, value: num, onInput: handle, onChange: handle }),
    /* @__PURE__ */ jsx46("span", { className: "mimicus-slider__value", children: num })
  ] });
}
function IconTextField({ field, state: state2, patchState }) {
  ...
  return /* @__PURE__ */ jsx46(InputDecorated, { label: field.label, icon: field.labelIcon, children: /* @__PURE__ */ jsxs28("div", { style: { display: "grid", gap: "0.6rem" }, children: [
    ...
    /* @__PURE__ */ jsxs28("label", { style: { display: "grid", gap: "0.3rem" }, children: [
      /* @__PURE__ */ jsx46("span", { style: { fontSize: "0.8rem", opacity: 0.85 }, children: "Texto" }),
...
function DemoConfigRenderer({ fields, state: state2, onStateChange }) {
  ...
  return typedFields.map((field) => {
    ...
    if (field.kind === "switch") {
      return wrap(/* @__PURE__ */ jsx46(InputDecorated, { label: field.label, icon: field.labelIcon ?? "mdi:tune", children: /* @__PURE__ */ jsx46(SwitchRow, { checked: state2[field.key], label: field.label, onChange: (v) => patchState(String(field.key), v) }) }));
    }
    if (field.kind === "switch-group") {
      return wrap(
        /* @__PURE__ */ jsx46(InputDecorated, { label: field.label, icon: field.labelIcon, children: /* @__PURE__ */ jsx46("div", { style: { display: "flex", flexWrap: "wrap", gap: "0.75rem" }, children: field.switches.map((sw) => /* @__PURE__ */ jsx46(SwitchRow, { checked: state2[sw.key], label: sw.label, onChange: (v) => patchState(String(sw.key), v) }, String(sw.key))) }) })
      );
    }
    if (field.kind === "text") {
      if (field.normalize) {
    ...
    adapter && /* @__PURE__ */ jsxs28("section", { className: "pg-demo-doc__section pg-demo-doc__section--playground", "aria-labelledby": `${demoId ?? finalTitle}-playground`, children: [
      ...
      /* @__PURE__ */ jsxs28(ConfigCard, { className: "pg-demo-config-section demo-config-shell", children: [
        /* @__PURE__ */ jsxs28("div", { style: { display: "grid", gridTemplateColumns: `repeat(${configCols}, minmax(0, 1fr))`, gap: "0.75rem", width: "100%", alignItems: "start" }, children: [
          ...
          /* @__PURE__ */ jsx46(ConfigCard, { children: /* @__PURE__ */ jsx46(InputDecorated, { label: "className", icon: "mdi:code-braces", children: /* @__PURE__ */ jsx46(ConfigCodeField, { value: demoClass, onChange: (v) => onDemoClassChange?.(v), placeholder: "clases CSS", minHeight: "4.5rem", maxHeight: "8.5rem" }) }) }),
...
import { useEffect as useEffect19, useMemo as useMemo11, useState as useState15 } from "react";
...
function PaginationPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx48("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx48(Pagination, { count: Math.round(Number(state2.count)) || 10, defaultPage: Math.round(Number(state2.defaultPage)) || 1, size: state2.size === "small" ? "small" : void 0, siblingCount: Math.round(Number(state2.siblingCount)) || 1 }) }, previewKey);
}
...
function InputPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx48("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx48(FormItem, { label: "Campo de texto", children: /* @__PURE__ */ jsx48(Input, { size: state2.size ?? "medium", disabled: state2.disabled, allowClear: Boolean(state2.allowClear), placeholder: details.placeholder ?? "Escribe aqu\xED\u2026", status: state2.status }) }) }, previewKey);
}
...
function SelectPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx48("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx48(Select, { size: state2.size, disabled: state2.disabled, placeholder: "Elige una opci\xF3n", options: DEMO_AUTOCOMPLETE, defaultValue: "react" }) }, previewKey);
}
...
function RatePreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx48("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx48(Rate, { defaultValue: 2.5, allowHalf: Boolean(state2.allowHalf), disabled: state2.disabled, size: state2.size }) }, previewKey);
}
...
function AvatarPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  ...
  ] }) : /* @__PURE__ */ jsx48(Avatar, { size: state2.size ?? "medium", variant: state2.variant ?? "circular", alt: "Remy Sharp", children: state2.withImage ? void 0 : "RS" }) }, previewKey);
}
...
function LoginButtonPreview({ previewKey, demoStyle, demoClass }) {
  ...
  return /* @__PURE__ */ jsx48(ContapymeSessionProvider, { session, children: /* @__PURE__ */ jsx48("div", { className: ["mimicus-login-button-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(mergeStyleString("width:100%;padding:0.65rem 0.75rem;border:1px solid var(--mimicus-b-color);border-radius:var(--mimicus-ui-radius,0.5rem);background:color-mix(in srgb,var(--mimicus-bg-secondary),transparent 8%)", demoStyle)), children: /* @__PURE__ */ jsxs30(FlexLayout, { items: "center", justify: "flex-end", gap: "0.5rem", children: [
    /* @__PURE__ */ jsx48("span", { style: { fontSize: "0.78rem", opacity: 0.75, marginRight: "auto" }, children: "AppLayout.Header.Tools" }),
    /* @__PURE__ */ jsx48(LoginButton, { showPasswordToggle: true, showRemember: true })
  ] }) }, previewKey) });
}
  ...
  return categories.map((cat) => {
    ...
    return /* @__PURE__ */ jsx49(SidePanelSection, { icon: meta.icon ?? "mdi:folder-outline", label: meta.label ?? cat, color, open: sectionOpen?.[cat], collapsed: false, active: route.category === cat && !route.slug, forceOpen: route.category === cat && !!route.slug, count: items.length, statusDots: statusDotsFor(items.map((it) => it.id)), onToggle: () => setSectionOpen?.((prev) => ({ ...prev, [cat]: !prev[cat] })), onHeaderClick: () => ctx.onCategory?.(cat), children: items.map((it) => {
      ...
      return /* @__PURE__ */ jsxs31(Button, { variant: selected ? "soft" : "text", shape: "rect", color, onClick: () => ctx.onDemo?.(cat, it.slug), className: "pg-panel-demo-link", title: it.displayLabel, style: { justifyContent: "flex-start", fontSize: "0.85rem", width: "100%" }, children: [
        ...
        /* @__PURE__ */ jsxs31("span", { className: "sm-item-label", children: [
          /* @__PURE__ */ jsx49("span", { className: "sm-item-text", children: it.displayLabel }),
          statusFor(it.id, it) && /* @__PURE__ */ jsx49(ReviewStatusDot, { status: statusFor(it.id, it), size: "0.48rem" })
        ] })
      ] }, it.slug);
    }) }, cat);
  });
...
import { useCallback as useCallback3, useEffect as useEffect20, useState as useState17 } from "react";
...
function PlaygroundSkinSelect({ label, value, options, onChange, accent: accent2 = "palette" }) {
  ...
  return /* @__PURE__ */ jsx53("div", { className: ["pg-skin-toggle", accent2 === "palette" ? "pg-skin-toggle--palette" : "pg-skin-toggle--look"].join(" "), ...dataProps, title: label, children: /* @__PURE__ */ jsx53("select", { className: "pg-skin-toggle__select", value, onChange: (e) => onChange?.(e.target.value), "aria-label": label, children: options.map((o) => /* @__PURE__ */ jsx53("option", { value: o.id, children: o.label }, o.id)) }) });
}
function HeaderSkinBar() {
  ...
  useEffect20(() => subscribeTheme(setTheme), []);
  useEffect20(() => subscribeLooknfeel(setLook), []);
  useEffect20(() => subscribePlaygroundAppLayoutVariant(setLayout), []);
  return /* @__PURE__ */ jsxs33("div", { className: "pg-header-skin-bar", children: [
    ...
    /* @__PURE__ */ jsx53(Button, { variant: theme.luminance === "dark" ? "soft" : "text", color: "neutral", shape: "rect", className: "pg-header-skin-bar__theme-btn", onClick: () => setLuminance(theme.luminance === "dark" ? "light" : "dark"), title: theme.luminance === "dark" ? "Modo claro" : "Modo oscuro", style: { width: "auto", minWidth: "2rem", flexShrink: 0 }, children: /* @__PURE__ */ jsx53("span", { "aria-hidden": true, children: theme.luminance === "dark" ? "\u2600" : "\u263E" }) })
  ] });
}
...
function PlaygroundAppShell({
  ...
  useEffect20(() => subscribePlaygroundAppLayoutVariant(setVariant), []);
  useEffect20(() => {
    try {
...
function Playground({ catalog = [], catalogMeta, sectionsMeta, shellConfig: shellConfigProp, previewTemplates, brand }) {
  ...
  const [navState, setNavState] = useState18(() => urlState2.get());
