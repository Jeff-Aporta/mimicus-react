...
import { useEffect as useEffect20, useMemo as useMemo12, useState as useState17 } from "react";
...
import { useCallback as useCallback2, useEffect as useEffect17, useLayoutEffect, useMemo as useMemo7, useRef as useRef13, useState as useState11 } from "react";

// src/datagrid/react/useGridModel.ts
import { useEffect as useEffect14, useRef as useRef9, useSyncExternalStore } from "react";
...
registerCellRenderer("boolean", ({ value }) => /* @__PURE__ */ jsx36(Icon, { icon: value ? "mdi:check-circle" : "mdi:close-circle-outline", className: value ? "mim-dg-bool mim-dg-bool--on" : "mim-dg-bool mim-dg-bool--off" }));
...
function GridBody(props) {
  ...
  return /* @__PURE__ */ jsx38("div", { className: "mim-dg__body", style: { height: totalHeight, width: totalWidth }, role: "rowgroup", children: /* @__PURE__ */ jsx38("div", { className: "mim-dg__rows", style: { transform: `translateY(${topPad}px)` }, children: rows.map((node) => {
...
import { Fragment as Fragment7, jsx as jsx41, jsxs as jsxs23 } from "react/jsx-runtime";
function HeaderMenu(props) {
  ...
  return /* @__PURE__ */ jsxs23("div", { ref, className: "mim-dg__menu pg-scrollbar", style: { left: x, top: y }, role: "menu", children: [
    column.sortable && /* @__PURE__ */ jsxs23(Fragment7, { children: [
      /* @__PURE__ */ jsxs23("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onSort(column.colId, "asc")), children: [
        /* @__PURE__ */ jsx41(Icon, { icon: "mdi:sort-ascending" }),
        "Ordenar ascendente"
      ] }),
      /* @__PURE__ */ jsxs23("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onSort(column.colId, "desc")), children: [
        /* @__PURE__ */ jsx41(Icon, { icon: "mdi:sort-descending" }),
        "Ordenar descendente"
      ] }),
      /* @__PURE__ */ jsxs23("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onSort(column.colId, null)), children: [
        /* @__PURE__ */ jsx41(Icon, { icon: "mdi:sort-variant-remove" }),
        "Quitar orden"
      ] }),
      /* @__PURE__ */ jsx41("div", { className: "mim-dg__menu-sep" })
    ] }),
    column.filterType && /* @__PURE__ */ jsxs23(Fragment7, { children: [
      /* @__PURE__ */ jsxs23("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onFilter(column)), children: [
        /* @__PURE__ */ jsx41(Icon, { icon: "mdi:filter-outline" }),
        "Filtrar\u2026"
      ] }),
      /* @__PURE__ */ jsx41("div", { className: "mim-dg__menu-sep" })
    ] }),
    /* @__PURE__ */ jsxs23("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onPin(column.colId, "left")), children: [
      /* @__PURE__ */ jsx41(Icon, { icon: "mdi:pin" }),
      "Fijar a la izquierda"
    ] }),
    /* @__PURE__ */ jsxs23("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onPin(column.colId, "right")), children: [
      /* @__PURE__ */ jsx41(Icon, { icon: "mdi:pin" }),
      "Fijar a la derecha"
    ] }),
    /* @__PURE__ */ jsxs23("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onPin(column.colId, null)), children: [
      /* @__PURE__ */ jsx41(Icon, { icon: "mdi:pin-off-outline" }),
      "No fijar"
    ] }),
    /* @__PURE__ */ jsx41("div", { className: "mim-dg__menu-sep" }),
    /* @__PURE__ */ jsxs23("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onAutosize(column.colId)), children: [
      /* @__PURE__ */ jsx41(Icon, { icon: "mdi:arrow-expand-horizontal" }),
      "Autoajustar ancho"
    ] }),
    /* @__PURE__ */ jsxs23("button", { type: "button", className: "mim-dg__menu-item", role: "menuitem", onClick: act(() => onHide(column.colId)), children: [
      /* @__PURE__ */ jsx41(Icon, { icon: "mdi:eye-off-outline" }),
      "Ocultar columna"
    ] })
  ] });
}
...
import { useEffect as useEffect16, useMemo as useMemo6, useRef as useRef12, useState as useState10 } from "react";
...
function FilterPopover(props) {
  ...
  return /* @__PURE__ */ jsxs24("div", { ref, className: "mim-dg__filter pg-scrollbar", style: { left: x, top: y }, role: "dialog", "aria-label": `Filtrar ${column.headerName}`, children: [
    type === "text" && /* @__PURE__ */ jsxs24(Fragment8, { children: [
      /* @__PURE__ */ jsx42("select", { className: "mim-dg__filter-field", value: textOp, onChange: (e) => setTextOp(e.target.value), children: TEXT_OPS.map((o) => /* @__PURE__ */ jsx42("option", { value: o.v, children: o.t }, o.v)) }),
      needsValue(textOp) && /* @__PURE__ */ jsx42("input", { className: "mim-dg__filter-field", placeholder: "Valor\u2026", autoFocus: true, value: textVal, onChange: (e) => setTextVal(e.target.value), onKeyDown: (e) => e.key === "Enter" && apply() })
    ] }),
    type === "number" && /* @__PURE__ */ jsxs24(Fragment8, { children: [
      /* @__PURE__ */ jsx42("select", { className: "mim-dg__filter-field", value: numOp, onChange: (e) => setNumOp(e.target.value), children: NUM_OPS.map((o) => /* @__PURE__ */ jsx42("option", { value: o.v, children: o.t }, o.v)) }),
      needsValue(numOp) && /* @__PURE__ */ jsx42("input", { type: "number", className: "mim-dg__filter-field", placeholder: "Valor\u2026", autoFocus: true, value: numVal, onChange: (e) => setNumVal(e.target.value), onKeyDown: (e) => e.key === "Enter" && apply() }),
      numOp === "inRange" && /* @__PURE__ */ jsx42("input", { type: "number", className: "mim-dg__filter-field", placeholder: "Hasta\u2026", value: numTo, onChange: (e) => setNumTo(e.target.value) })
    ] }),
    type === "date" && /* @__PURE__ */ jsxs24(Fragment8, { children: [
      /* @__PURE__ */ jsx42("select", { className: "mim-dg__filter-field", value: dateOp, onChange: (e) => setDateOp(e.target.value), children: DATE_OPS.map((o) => /* @__PURE__ */ jsx42("option", { value: o.v, children: o.t }, o.v)) }),
      /* @__PURE__ */ jsx42("input", { type: "date", className: "mim-dg__filter-field", value: dateVal, onChange: (e) => setDateVal(e.target.value) }),
      dateOp === "inRange" && /* @__PURE__ */ jsx42("input", { type: "date", className: "mim-dg__filter-field", value: dateTo, onChange: (e) => setDateTo(e.target.value) })
    ] }),
    type === "set" && /* @__PURE__ */ jsxs24(Fragment8, { children: [
      /* @__PURE__ */ jsx42("input", { className: "mim-dg__filter-field", placeholder: "Buscar valores\u2026", value: setSearch, onChange: (e) => setSetSearch(e.target.value) }),
      /* @__PURE__ */ jsxs24("div", { className: "mim-dg__filter-actions-row", children: [
        /* @__PURE__ */ jsx42("button", { type: "button", className: "mim-dg__filter-link", onClick: () => setSetSel(new Set(uniqueValues2)), children: "Todo" }),
        /* @__PURE__ */ jsx42("button", { type: "button", className: "mim-dg__filter-link", onClick: () => setSetSel(/* @__PURE__ */ new Set()), children: "Nada" })
      ] }),
      /* @__PURE__ */ jsx42("div", { className: "mim-dg__filter-set pg-scrollbar", children: shownVals.map((v) => /* @__PURE__ */ jsxs24("label", { className: "mim-dg__filter-set-item", children: [
        /* @__PURE__ */ jsx42("button", { type: "button", className: `mim-dg__checkbox mim-dg__checkbox--${setSel.has(v) ? "all" : "none"}`, onClick: () => toggleVal(v), children: /* @__PURE__ */ jsx42(Icon, { icon: setSel.has(v) ? "mdi:checkbox-marked" : "mdi:checkbox-blank-outline" }) }),
        /* @__PURE__ */ jsx42("span", { children: v || "(vac\xEDo)" })
      ] }, v)) })
    ] }),
    /* @__PURE__ */ jsxs24("div", { className: "mim-dg__filter-actions", children: [
      /* @__PURE__ */ jsx42("button", { type: "button", className: "mim-dg__tool-btn", onClick: clear, children: "Limpiar" }),
      /* @__PURE__ */ jsx42("button", { type: "button", className: "mim-dg__tool-btn is-primary", onClick: apply, children: "Aplicar" })
    ] })
  ] });
}
...
function DataGrid2(props) {
  ...
  const orderedIds = useMemo7(() => dataRows.map((r) => r.id), [dataRows]);
  ...
  const onToggleAll = useCallback2(() => emit2(headerCheckbox === "all" ? clearSelection() : selectAll(dataRows)), [emit2, headerCheckbox, dataRows]);
  ...
  return /* @__PURE__ */ jsxs25("div", { className: `mim-dg${className ? ` ${className}` : ""}`, "data-density": density, style: { height, ...style }, children: [
    toolbar && /* @__PURE__ */ jsx43(
      GridToolbar,
      {
    ...
    /* @__PURE__ */ jsxs25("div", { className: "mim-dg__viewport pg-scrollbar", ref: viewportRef, onScroll, onKeyDown, tabIndex: 0, role: "grid", "aria-rowcount": state2.totalRows, children: [
      /* @__PURE__ */ jsx43(
        GridHeader,
        {
          columns: flat,
    ...
    /* @__PURE__ */ jsx43(GridFooter, { page: state2.page, pageSize: state2.pageSize, totalRows: state2.totalRows, selectedCount: state2.selection.size, pagination, onPage }),
    menu && /* @__PURE__ */ jsx43(
      HeaderMenu,
      {
        column: menu.col,
...
// src/devkit/catalog/catalogUi.tsx
import { Fragment as Fragment9, jsx as jsx44, jsxs as jsxs26 } from "react/jsx-runtime";
var demoIcons = {
...
function Badge2({ children, className, style }) {
  return /* @__PURE__ */ jsx44("span", { className: ["mimicus-badge", "catalog-badge", className].filter(Boolean).join(" "), style, children });
}
...
function ReviewStatusDot({ status, color, size = "0.58rem" }) {
  ...
  return /* @__PURE__ */ jsx44("span", { className: "review-status-dot", style: { width: size, height: size, background: resolveColor(c) }, title: status ?? c, "aria-hidden": true });
}
...
function DefaultSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "32", y: "24", width: "56", height: "32", rx: "7", stroke, strokeWidth: "1.3", opacity: faint }),
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "40", r: "7", fill: accent, fillOpacity: "0.2", stroke: accent, strokeWidth: "1.5" })
  ] });
}
function ButtonSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "14", y: "30", width: "40", height: "16", rx: "5", fill: accent, fillOpacity: "0.22", stroke: accent, strokeWidth: "1.5" }),
    /* @__PURE__ */ jsx44("line", { x1: "22", y1: "38", x2: "46", y2: "38", stroke: accent, strokeWidth: "1.6", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("rect", { x: "66", y: "30", width: "40", height: "16", rx: "5", stroke, strokeWidth: "1.3", opacity: 0.32 })
  ] });
}
function FloatButtonSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "18", y: "16", width: "84", height: "48", rx: "6", stroke, strokeWidth: "1.1", opacity: 0.22 }),
    /* @__PURE__ */ jsx44("circle", { cx: "86", cy: "52", r: "11", fill: accent, fillOpacity: "0.22", stroke: accent, strokeWidth: "1.5" }),
    /* @__PURE__ */ jsx44("line", { x1: "86", y1: "47", x2: "86", y2: "57", stroke: accent, strokeWidth: "1.7", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "81", y1: "52", x2: "91", y2: "52", stroke: accent, strokeWidth: "1.7", strokeLinecap: "round" })
  ] });
}
function LinkSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("line", { x1: "30", y1: "44", x2: "74", y2: "44", stroke: accent, strokeWidth: "1.6", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("path", { d: "M52 34 h22 a6 6 0 0 1 0 12 h-10", stroke: accent, strokeWidth: "1.5", fill: "none", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("path", { d: "M68 34 h-22 a6 6 0 0 0 0 12 h10", stroke, strokeWidth: "1.4", fill: "none", opacity: faint, strokeLinecap: "round" })
  ] });
}
function CardSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "26", y: "16", width: "68", height: "52", rx: "7", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "26", y: "16", width: "68", height: "14", rx: "7", fill: accent, fillOpacity: "0.25" }),
    /* @__PURE__ */ jsx44("line", { x1: "34", y1: "40", x2: "86", y2: "40", stroke, strokeWidth: "1.3", opacity: faint })
  ] });
}
function BoxSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "30", y: "20", width: "60", height: "40", rx: "5", fill: accent, fillOpacity: "0.12", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("rect", { x: "38", y: "28", width: "44", height: "24", rx: "3", stroke, strokeWidth: "1.2", opacity: faint, strokeDasharray: "3 3" })
  ] });
}
function ContainerSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "14", y: "16", width: "92", height: "48", rx: "5", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "22", width: "52", height: "36", rx: "4", fill: accent, fillOpacity: "0.14", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("line", { x1: "28", y1: "16", x2: "28", y2: "64", stroke, strokeWidth: "1", opacity: 0.22, strokeDasharray: "3 3" }),
    /* @__PURE__ */ jsx44("line", { x1: "92", y1: "16", x2: "92", y2: "64", stroke, strokeWidth: "1", opacity: 0.22, strokeDasharray: "3 3" })
  ] });
}
function GridSketch() {
  return /* @__PURE__ */ jsx44(Fragment9, { children: [26, 50, 74].map(
    (x) => [22, 46].map((y) => /* @__PURE__ */ jsx44("rect", { x, y, width: "18", height: "14", rx: "3", fill: accent, fillOpacity: "0.14", stroke: accent, strokeWidth: "1.2" }, `${x}-${y}`))
  ) });
}
function MasonrySketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "26", y: "20", width: "20", height: "24", rx: "3", fill: accent, fillOpacity: "0.16", stroke: accent, strokeWidth: "1.2" }),
    /* @__PURE__ */ jsx44("rect", { x: "26", y: "48", width: "20", height: "14", rx: "3", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "50", y: "20", width: "20", height: "14", rx: "3", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "50", y: "38", width: "20", height: "24", rx: "3", fill: accent, fillOpacity: "0.16", stroke: accent, strokeWidth: "1.2" }),
    /* @__PURE__ */ jsx44("rect", { x: "74", y: "20", width: "20", height: "20", rx: "3", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "74", y: "44", width: "20", height: "18", rx: "3", fill: accent, fillOpacity: "0.16", stroke: accent, strokeWidth: "1.2" })
  ] });
}
function ImageListSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    [26, 50, 74].map(
      (x) => [22, 46].map((y) => /* @__PURE__ */ jsx44("rect", { x, y, width: "18", height: "14", rx: "2", fill: accent, fillOpacity: "0.1", stroke: accent, strokeWidth: "1.1" }, `${x}-${y}`))
    ),
    /* @__PURE__ */ jsx44("circle", { cx: "32", cy: "28", r: "2.2", fill: accent }),
    /* @__PURE__ */ jsx44("path", { d: "M28 36 l5 -5 l4 4 l3 -3 l4 4", stroke: accent, strokeWidth: "1.2", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
function FlexSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "18", y: "18", width: "84", height: "44", rx: "6", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "24", y: "26", width: "20", height: "28", rx: "3", fill: accent, fillOpacity: "0.18", stroke: accent, strokeWidth: "1.2" }),
    /* @__PURE__ */ jsx44("rect", { x: "50", y: "26", width: "20", height: "28", rx: "3", fill: accent, fillOpacity: "0.18", stroke: accent, strokeWidth: "1.2" }),
    /* @__PURE__ */ jsx44("rect", { x: "76", y: "26", width: "20", height: "28", rx: "3", fill: accent, fillOpacity: "0.18", stroke: accent, strokeWidth: "1.2" })
  ] });
}
function StackSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "20", width: "52", height: "11", rx: "3", fill: accent, fillOpacity: "0.18", stroke: accent, strokeWidth: "1.2" }),
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "35", width: "52", height: "11", rx: "3", fill: accent, fillOpacity: "0.14", stroke: accent, strokeWidth: "1.2" }),
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "50", width: "52", height: "11", rx: "3", stroke, strokeWidth: "1.2", opacity: faint })
  ] });
}
function SpaceSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "22", y: "32", width: "18", height: "16", rx: "3", fill: accent, fillOpacity: "0.18", stroke: accent, strokeWidth: "1.2" }),
    /* @__PURE__ */ jsx44("rect", { x: "80", y: "32", width: "18", height: "16", rx: "3", fill: accent, fillOpacity: "0.18", stroke: accent, strokeWidth: "1.2" }),
    /* @__PURE__ */ jsx44("line", { x1: "44", y1: "40", x2: "76", y2: "40", stroke, strokeWidth: "1.2", opacity: faint, strokeDasharray: "3 3" }),
    /* @__PURE__ */ jsx44("path", { d: "M48 36 l-4 4 l4 4 M72 36 l4 4 l-4 4", stroke: accent, strokeWidth: "1.3", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
function AppShellSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "16", y: "16", width: "88", height: "48", rx: "5", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "16", y: "16", width: "88", height: "11", rx: "5", fill: accent, fillOpacity: "0.2" }),
    /* @__PURE__ */ jsx44("rect", { x: "16", y: "27", width: "22", height: "37", fill: accent, fillOpacity: "0.12", stroke: accent, strokeWidth: "1.1" }),
    /* @__PURE__ */ jsx44("line", { x1: "46", y1: "36", x2: "96", y2: "36", stroke, strokeWidth: "1.1", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "46", y1: "46", x2: "96", y2: "46", stroke, strokeWidth: "1.1", opacity: faint })
  ] });
}
function SplitterSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "18", y: "20", width: "84", height: "40", rx: "5", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "60", y1: "20", x2: "60", y2: "60", stroke: accent, strokeWidth: "1.6" }),
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "40", r: "6", fill: accent, fillOpacity: "0.2", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("path", { d: "M50 36 l-4 4 l4 4 M70 36 l4 4 l-4 4", stroke: accent, strokeWidth: "1.3", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
function DividerSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("line", { x1: "26", y1: "30", x2: "94", y2: "30", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "26", y1: "40", x2: "94", y2: "40", stroke: accent, strokeWidth: "1.8", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "26", y1: "50", x2: "94", y2: "50", stroke, strokeWidth: "1.2", opacity: faint })
  ] });
}
function SwitchSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "34", width: "52", height: "20", rx: "10", fill: accent, fillOpacity: "0.15", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("circle", { cx: "48", cy: "44", r: "7", fill: accent, fillOpacity: "0.85" })
  ] });
}
function ToggleButtonSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "24", y: "32", width: "72", height: "18", rx: "5", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "24", y: "32", width: "36", height: "18", rx: "5", fill: accent, fillOpacity: "0.22", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("line", { x1: "60", y1: "32", x2: "60", y2: "50", stroke, strokeWidth: "1.1", opacity: faint })
  ] });
}
function CheckboxChipSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "26", y: "32", width: "68", height: "18", rx: "9", fill: accent, fillOpacity: "0.16", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("circle", { cx: "37", cy: "41", r: "5", fill: accent, fillOpacity: "0.3", stroke: accent, strokeWidth: "1.3" }),
    /* @__PURE__ */ jsx44("path", { d: "M34.5 41 l1.8 1.8 l3.2 -3.6", stroke: accent, strokeWidth: "1.5", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "48", y1: "41", x2: "86", y2: "41", stroke, strokeWidth: "1.4", opacity: faint, strokeLinecap: "round" })
  ] });
}
function CheckRadioSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "30", y: "28", width: "16", height: "16", rx: "3", fill: accent, fillOpacity: "0.22", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("path", { d: "M33.5 36 l3 3 l6 -7", stroke: accent, strokeWidth: "1.7", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("circle", { cx: "78", cy: "36", r: "9", stroke, strokeWidth: "1.4", opacity: faint }),
    /* @__PURE__ */ jsx44("circle", { cx: "78", cy: "36", r: "4", fill: accent, fillOpacity: "0.85" }),
    /* @__PURE__ */ jsx44("line", { x1: "30", y1: "54", x2: "90", y2: "54", stroke, strokeWidth: "1.2", opacity: 0.2 })
  ] });
}
function InputSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "32", width: "80", height: "18", rx: "4", stroke: accent, strokeWidth: "1.4", fill: accent, fillOpacity: "0.06" }),
    /* @__PURE__ */ jsx44("line", { x1: "28", y1: "41", x2: "28", y2: "41", stroke: accent, strokeWidth: "0" }),
    /* @__PURE__ */ jsx44("rect", { x: "27", y: "36", width: "1.6", height: "10", rx: "1", fill: accent }),
    /* @__PURE__ */ jsx44("line", { x1: "33", y1: "41", x2: "70", y2: "41", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" })
  ] });
}
function InputNumberSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "32", width: "80", height: "18", rx: "4", stroke: accent, strokeWidth: "1.4", fill: accent, fillOpacity: "0.06" }),
    /* @__PURE__ */ jsx44("line", { x1: "28", y1: "41", x2: "60", y2: "41", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "84", y1: "32", x2: "84", y2: "50", stroke, strokeWidth: "1.1", opacity: faint }),
    /* @__PURE__ */ jsx44("path", { d: "M88 39 l3 -3 l3 3 M88 43 l3 3 l3 -3", stroke: accent, strokeWidth: "1.3", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
function SelectSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "28", width: "80", height: "18", rx: "4", stroke: accent, strokeWidth: "1.4", fill: accent, fillOpacity: "0.06" }),
    /* @__PURE__ */ jsx44("line", { x1: "28", y1: "37", x2: "68", y2: "37", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("path", { d: "M85 34 l4 4 l4 -4", stroke: accent, strokeWidth: "1.5", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "50", width: "80", height: "12", rx: "3", fill: accent, fillOpacity: "0.1", stroke, strokeWidth: "1", opacity: 0.5 })
  ] });
}
function CalendarSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "28", y: "20", width: "64", height: "44", rx: "5", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "28", y: "20", width: "64", height: "12", rx: "5", fill: accent, fillOpacity: "0.22" }),
    /* @__PURE__ */ jsx44("line", { x1: "40", y1: "16", x2: "40", y2: "24", stroke: accent, strokeWidth: "1.5", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "80", y1: "16", x2: "80", y2: "24", stroke: accent, strokeWidth: "1.5", strokeLinecap: "round" }),
    [38, 50, 62, 74].map(
      (x) => [40, 52].map((y) => /* @__PURE__ */ jsx44("circle", { cx: x, cy: y, r: "2.2", fill: x === 50 && y === 52 ? accent : stroke, opacity: x === 50 && y === 52 ? 1 : faint }, `${x}-${y}`))
    )
  ] });
}
function TimeSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "40", r: "22", stroke, strokeWidth: "1.3", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "60", y1: "40", x2: "60", y2: "26", stroke: accent, strokeWidth: "1.7", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "60", y1: "40", x2: "72", y2: "44", stroke: accent, strokeWidth: "1.7", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "40", r: "2.4", fill: accent })
  ] });
}
function ColorPickerSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "30", y: "20", width: "60", height: "36", rx: "5", stroke, strokeWidth: "1.2", opacity: faint, fill: accent, fillOpacity: "0.1" }),
    /* @__PURE__ */ jsx44("circle", { cx: "56", cy: "36", r: "7", fill: accent, fillOpacity: "0.5", stroke: accent, strokeWidth: "1.3" }),
    /* @__PURE__ */ jsx44("rect", { x: "30", y: "60", width: "60", height: "6", rx: "3", fill: accent, fillOpacity: "0.25", stroke: accent, strokeWidth: "1" }),
    /* @__PURE__ */ jsx44("circle", { cx: "70", cy: "63", r: "3.5", fill: accent, stroke, strokeWidth: "1" })
  ] });
}
function SliderSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("line", { x1: "24", y1: "40", x2: "96", y2: "40", stroke, strokeWidth: "1.4", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "24", y1: "40", x2: "64", y2: "40", stroke: accent, strokeWidth: "2", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("circle", { cx: "64", cy: "40", r: "7", fill: accent, fillOpacity: "0.25", stroke: accent, strokeWidth: "1.6" })
  ] });
}
function RateSketch() {
  const star = (cx5, on2) => `M${cx5} 32 l2.4 5 l5.4 .6 l-4 3.7 l1.1 5.3 l-4.9 -2.7 l-4.9 2.7 l1.1 -5.3 l-4 -3.7 l5.4 -.6 z`;
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("path", { d: star(36), fill: accent, fillOpacity: "0.7", stroke: accent, strokeWidth: "1" }),
    /* @__PURE__ */ jsx44("path", { d: star(60), fill: accent, fillOpacity: "0.7", stroke: accent, strokeWidth: "1" }),
    /* @__PURE__ */ jsx44("path", { d: star(84), fill: "none", stroke, strokeWidth: "1.2", opacity: faint })
  ] });
}
function UploadSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "26", y: "22", width: "68", height: "40", rx: "6", stroke: accent, strokeWidth: "1.4", strokeDasharray: "4 3", fill: accent, fillOpacity: "0.06" }),
    /* @__PURE__ */ jsx44("path", { d: "M60 52 l0 -18 M52 40 l8 -8 l8 8", stroke: accent, strokeWidth: "1.7", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
function TransferSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "22", width: "32", height: "36", rx: "4", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "68", y: "22", width: "32", height: "36", rx: "4", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "25", y: "28", width: "22", height: "6", rx: "2", fill: accent, fillOpacity: "0.3" }),
    /* @__PURE__ */ jsx44("rect", { x: "73", y: "28", width: "22", height: "6", rx: "2", fill: accent, fillOpacity: "0.2" }),
    /* @__PURE__ */ jsx44("path", { d: "M55 36 l8 0 M60 33 l4 3 l-4 3", stroke: accent, strokeWidth: "1.4", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("path", { d: "M65 46 l-8 0 M60 43 l-4 3 l4 3", stroke: accent, strokeWidth: "1.4", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
function FormSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "24", y: "16", width: "72", height: "48", rx: "5", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "32", y1: "26", x2: "52", y2: "26", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("rect", { x: "32", y: "30", width: "56", height: "9", rx: "2", stroke: accent, strokeWidth: "1.2", fill: accent, fillOpacity: "0.06" }),
    /* @__PURE__ */ jsx44("line", { x1: "32", y1: "46", x2: "48", y2: "46", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("rect", { x: "32", y: "50", width: "30", height: "9", rx: "2", fill: accent, fillOpacity: "0.22", stroke: accent, strokeWidth: "1.2" })
  ] });
}
function TextSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("line", { x1: "26", y1: "28", x2: "94", y2: "28", stroke, strokeWidth: "1.6", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "26", y1: "38", x2: "86", y2: "38", stroke, strokeWidth: "1.6", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "26", y1: "48", x2: "90", y2: "48", stroke: accent, strokeWidth: "1.6", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "26", y1: "58", x2: "60", y2: "58", stroke, strokeWidth: "1.6", opacity: faint, strokeLinecap: "round" })
  ] });
}
function HeadingsSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("text", { x: "30", y: "48", fontSize: "34", fontWeight: "700", fill: accent, fillOpacity: "0.85", fontFamily: "sans-serif", children: "H" }),
    /* @__PURE__ */ jsx44("line", { x1: "58", y1: "30", x2: "92", y2: "30", stroke, strokeWidth: "1.5", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "58", y1: "42", x2: "86", y2: "42", stroke, strokeWidth: "1.5", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "58", y1: "54", x2: "90", y2: "54", stroke, strokeWidth: "1.5", opacity: faint, strokeLinecap: "round" })
  ] });
}
function CodeBlockSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "22", y: "20", width: "76", height: "40", rx: "5", stroke, strokeWidth: "1.2", opacity: faint, fill: accent, fillOpacity: "0.05" }),
    /* @__PURE__ */ jsx44("path", { d: "M44 32 l-7 8 l7 8 M76 32 l7 8 l-7 8", stroke: accent, strokeWidth: "1.6", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "56", y1: "30", x2: "64", y2: "50", stroke: accent, strokeWidth: "1.5", strokeLinecap: "round" })
  ] });
}
function TabsSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "24", width: "80", height: "36", rx: "5", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "24", width: "28", height: "13", rx: "5", fill: accent, fillOpacity: "0.22", stroke: accent, strokeWidth: "1.3" }),
    /* @__PURE__ */ jsx44("line", { x1: "48", y1: "37", x2: "100", y2: "37", stroke, strokeWidth: "1.1", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "56", y1: "31", x2: "70", y2: "31", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "80", y1: "31", x2: "94", y2: "31", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" })
  ] });
}
function MenuSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "20", width: "52", height: "44", rx: "5", stroke, strokeWidth: "1.2", opacity: faint, fill: accent, fillOpacity: "0.05" }),
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "20", width: "52", height: "12", rx: "5", fill: accent, fillOpacity: "0.2" }),
    /* @__PURE__ */ jsx44("line", { x1: "42", y1: "42", x2: "78", y2: "42", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "42", y1: "52", x2: "70", y2: "52", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" })
  ] });
}
function BreadcrumbSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("line", { x1: "22", y1: "40", x2: "40", y2: "40", stroke: accent, strokeWidth: "1.6", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("path", { d: "M46 35 l5 5 l-5 5", stroke, strokeWidth: "1.3", fill: "none", opacity: faint, strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "56", y1: "40", x2: "72", y2: "40", stroke, strokeWidth: "1.5", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("path", { d: "M78 35 l5 5 l-5 5", stroke, strokeWidth: "1.3", fill: "none", opacity: faint, strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "88", y1: "40", x2: "98", y2: "40", stroke, strokeWidth: "1.5", opacity: faint, strokeLinecap: "round" })
  ] });
}
function PaginationSketch() {
  return /* @__PURE__ */ jsx44(Fragment9, { children: [26, 46, 66, 86].map((x, i) => /* @__PURE__ */ jsx44("rect", { x, y: "32", width: "16", height: "16", rx: "4", fill: i === 1 ? accent : "none", fillOpacity: i === 1 ? 0.22 : 0, stroke: i === 1 ? accent : stroke, strokeWidth: i === 1 ? 1.4 : 1.2, opacity: i === 1 ? 1 : faint }, x)) });
}
function StepsSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("line", { x1: "30", y1: "40", x2: "90", y2: "40", stroke, strokeWidth: "1.3", opacity: faint }),
    /* @__PURE__ */ jsx44("circle", { cx: "30", cy: "40", r: "6", fill: accent, fillOpacity: "0.3", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("path", { d: "M27.5 40 l1.8 1.8 l3.2 -3.6", stroke: accent, strokeWidth: "1.4", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "40", r: "6", fill: accent, fillOpacity: "0.18", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("circle", { cx: "90", cy: "40", r: "6", stroke, strokeWidth: "1.3", opacity: faint })
  ] });
}
function BottomNavSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "18", y: "20", width: "84", height: "40", rx: "5", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "18", y1: "48", x2: "102", y2: "48", stroke, strokeWidth: "1.1", opacity: faint }),
    /* @__PURE__ */ jsx44("circle", { cx: "38", cy: "54", r: "3", fill: accent }),
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "54", r: "3", fill: stroke, opacity: faint }),
    /* @__PURE__ */ jsx44("circle", { cx: "82", cy: "54", r: "3", fill: stroke, opacity: faint })
  ] });
}
function SpeedDialSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("circle", { cx: "84", cy: "56", r: "10", fill: accent, fillOpacity: "0.22", stroke: accent, strokeWidth: "1.5" }),
    /* @__PURE__ */ jsx44("line", { x1: "84", y1: "51", x2: "84", y2: "61", stroke: accent, strokeWidth: "1.6", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "79", y1: "56", x2: "89", y2: "56", stroke: accent, strokeWidth: "1.6", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("circle", { cx: "84", cy: "34", r: "5", stroke, strokeWidth: "1.3", opacity: faint }),
    /* @__PURE__ */ jsx44("circle", { cx: "62", cy: "48", r: "5", stroke, strokeWidth: "1.3", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "84", y1: "46", x2: "84", y2: "39", stroke, strokeWidth: "1", opacity: 0.25, strokeDasharray: "2 2" })
  ] });
}
function DrawerSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "18", y: "18", width: "84", height: "44", rx: "5", stroke, strokeWidth: "1.1", opacity: 0.22 }),
    /* @__PURE__ */ jsx44("rect", { x: "66", y: "18", width: "36", height: "44", rx: "5", fill: accent, fillOpacity: "0.14", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("line", { x1: "74", y1: "30", x2: "94", y2: "30", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "74", y1: "40", x2: "90", y2: "40", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" })
  ] });
}
function ModalSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "22", y: "14", width: "76", height: "52", rx: "6", stroke, strokeWidth: "1.1", opacity: 0.22 }),
    /* @__PURE__ */ jsx44("rect", { x: "30", y: "22", width: "60", height: "36", rx: "5", fill: accent, fillOpacity: "0.12", stroke: accent, strokeWidth: "1.3" }),
    /* @__PURE__ */ jsx44("line", { x1: "38", y1: "32", x2: "82", y2: "32", stroke, strokeWidth: "1.2", opacity: faint })
  ] });
}
function AlertSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "22", y: "30", width: "76", height: "20", rx: "5", fill: accent, fillOpacity: "0.12", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("circle", { cx: "34", cy: "40", r: "6", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("line", { x1: "34", y1: "37", x2: "34", y2: "41", stroke: accent, strokeWidth: "1.5", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("circle", { cx: "34", cy: "44", r: "0.9", fill: accent }),
    /* @__PURE__ */ jsx44("line", { x1: "46", y1: "40", x2: "88", y2: "40", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" })
  ] });
}
function TooltipSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "22", width: "52", height: "22", rx: "5", fill: accent, fillOpacity: "0.16", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("path", { d: "M54 44 l6 7 l6 -7 z", fill: accent, fillOpacity: "0.16", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("line", { x1: "42", y1: "33", x2: "78", y2: "33", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "58", r: "3", stroke, strokeWidth: "1.2", opacity: faint })
  ] });
}
function TourSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "18", y: "18", width: "84", height: "44", rx: "5", stroke, strokeWidth: "1.1", opacity: 0.22 }),
    /* @__PURE__ */ jsx44("circle", { cx: "40", cy: "40", r: "11", stroke: accent, strokeWidth: "1.5", strokeDasharray: "3 2", fill: accent, fillOpacity: "0.08" }),
    /* @__PURE__ */ jsx44("rect", { x: "58", y: "32", width: "38", height: "18", rx: "4", fill: accent, fillOpacity: "0.14", stroke: accent, strokeWidth: "1.3" }),
    /* @__PURE__ */ jsx44("line", { x1: "64", y1: "41", x2: "90", y2: "41", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" })
  ] });
}
function BadgeSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "30", y: "34", width: "40", height: "16", rx: "8", fill: accent, fillOpacity: "0.2", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("line", { x1: "38", y1: "42", x2: "62", y2: "42", stroke: accent, strokeWidth: "1.4", opacity: 0.6, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("circle", { cx: "78", cy: "30", r: "7", fill: accent, fillOpacity: "0.85" }),
    /* @__PURE__ */ jsx44("circle", { cx: "78", cy: "30", r: "7", stroke, strokeWidth: "1.1", opacity: 0.2 })
  ] });
}
function AvatarSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "40", r: "20", fill: accent, fillOpacity: "0.12", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "34", r: "6", fill: accent, fillOpacity: "0.4" }),
    /* @__PURE__ */ jsx44("path", { d: "M48 54 a12 10 0 0 1 24 0", fill: accent, fillOpacity: "0.3" })
  ] });
}
function TableSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "20", width: "80", height: "40", rx: "4", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "20", width: "80", height: "11", fill: accent, fillOpacity: "0.2" }),
    /* @__PURE__ */ jsx44("line", { x1: "20", y1: "42", x2: "100", y2: "42", stroke, strokeWidth: "1", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "46", y1: "20", x2: "46", y2: "60", stroke, strokeWidth: "1", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "73", y1: "20", x2: "73", y2: "60", stroke, strokeWidth: "1", opacity: faint })
  ] });
}
function DataGridSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "16", y: "18", width: "88", height: "46", rx: "4", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "16", y: "18", width: "88", height: "11", fill: accent, fillOpacity: "0.22" }),
    /* @__PURE__ */ jsx44("rect", { x: "16", y: "18", width: "16", height: "46", fill: accent, fillOpacity: "0.08" }),
    /* @__PURE__ */ jsx44("line", { x1: "32", y1: "18", x2: "32", y2: "64", stroke: accent, strokeWidth: "1.1", opacity: "0.5" }),
    /* @__PURE__ */ jsx44("line", { x1: "58", y1: "18", x2: "58", y2: "64", stroke, strokeWidth: "1", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "82", y1: "18", x2: "82", y2: "64", stroke, strokeWidth: "1", opacity: faint }),
    [40, 51, 62].map((y) => /* @__PURE__ */ jsx44("line", { x1: "16", y1: y, x2: "104", y2: y, stroke, strokeWidth: "0.9", opacity: faint }, y)),
    /* @__PURE__ */ jsx44("path", { d: "M88 21 l3 3 l3 -3", stroke: accent, strokeWidth: "1.3", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("rect", { x: "20", y: "33", width: "8", height: "4", rx: "1", fill: accent, fillOpacity: "0.6" })
  ] });
}
function ListSketch() {
  return /* @__PURE__ */ jsx44(Fragment9, { children: [26, 38, 50].map((y) => /* @__PURE__ */ jsxs26("g", { children: [
    /* @__PURE__ */ jsx44("circle", { cx: "32", cy: y, r: "3", fill: accent, fillOpacity: "0.7" }),
    /* @__PURE__ */ jsx44("line", { x1: "42", y1: y, x2: "92", y2: y, stroke, strokeWidth: "1.4", opacity: faint, strokeLinecap: "round" })
  ] }, y)) });
}
function TreeSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "26", y: "24", width: "14", height: "9", rx: "2", fill: accent, fillOpacity: "0.3", stroke: accent, strokeWidth: "1.2" }),
    /* @__PURE__ */ jsx44("path", { d: "M33 33 v8 h10 M33 41 v8 h10", stroke, strokeWidth: "1.2", opacity: faint, fill: "none" }),
    /* @__PURE__ */ jsx44("rect", { x: "46", y: "37", width: "14", height: "9", rx: "2", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "46", y: "45", width: "14", height: "9", rx: "2", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "66", y: "24", width: "26", height: "9", rx: "2", stroke, strokeWidth: "1.2", opacity: faint })
  ] });
}
function TimelineSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("line", { x1: "36", y1: "20", x2: "36", y2: "60", stroke, strokeWidth: "1.3", opacity: faint }),
    [26, 40, 54].map((y, i) => /* @__PURE__ */ jsxs26("g", { children: [
      /* @__PURE__ */ jsx44("circle", { cx: "36", cy: y, r: "4", fill: i === 0 ? accent : "none", fillOpacity: i === 0 ? 0.4 : 0, stroke: accent, strokeWidth: "1.4" }),
      /* @__PURE__ */ jsx44("line", { x1: "46", y1: y, x2: i === 0 ? 90 : 78, y2: y, stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" })
    ] }, y))
  ] });
}
function AccordionSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "24", y: "20", width: "72", height: "14", rx: "3", fill: accent, fillOpacity: "0.18", stroke: accent, strokeWidth: "1.3" }),
    /* @__PURE__ */ jsx44("path", { d: "M84 25 l4 4 l4 -4", stroke: accent, strokeWidth: "1.4", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("rect", { x: "24", y: "38", width: "72", height: "22", rx: "3", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "32", y1: "46", x2: "80", y2: "46", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "32", y1: "53", x2: "68", y2: "53", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" })
  ] });
}
function CarouselSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "40", y: "24", width: "40", height: "32", rx: "4", fill: accent, fillOpacity: "0.16", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("rect", { x: "24", y: "30", width: "14", height: "20", rx: "3", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "82", y: "30", width: "14", height: "20", rx: "3", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("circle", { cx: "54", cy: "62", r: "2", fill: accent }),
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "62", r: "2", fill: stroke, opacity: faint }),
    /* @__PURE__ */ jsx44("circle", { cx: "66", cy: "62", r: "2", fill: stroke, opacity: faint })
  ] });
}
function StatisticSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("line", { x1: "30", y1: "26", x2: "58", y2: "26", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("text", { x: "29", y: "48", fontSize: "20", fontWeight: "700", fill: accent, fillOpacity: "0.85", fontFamily: "sans-serif", children: "1.2K" }),
    /* @__PURE__ */ jsx44("path", { d: "M76 50 l6 -8 l5 4 l8 -12", stroke: accent, strokeWidth: "1.6", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx44("path", { d: "M95 34 l0 5 l-5 0", stroke: accent, strokeWidth: "1.4", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
function QRCodeSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "20", width: "14", height: "14", rx: "2", stroke: accent, strokeWidth: "1.6" }),
    /* @__PURE__ */ jsx44("rect", { x: "72", y: "20", width: "14", height: "14", rx: "2", stroke: accent, strokeWidth: "1.6" }),
    /* @__PURE__ */ jsx44("rect", { x: "34", y: "46", width: "14", height: "14", rx: "2", stroke: accent, strokeWidth: "1.6" }),
    /* @__PURE__ */ jsx44("rect", { x: "38", y: "24", width: "6", height: "6", fill: accent, fillOpacity: "0.7" }),
    /* @__PURE__ */ jsx44("rect", { x: "72", y: "46", width: "5", height: "5", fill: stroke, opacity: faint }),
    /* @__PURE__ */ jsx44("rect", { x: "81", y: "46", width: "5", height: "5", fill: accent, fillOpacity: "0.5" }),
    /* @__PURE__ */ jsx44("rect", { x: "72", y: "55", width: "5", height: "5", fill: accent, fillOpacity: "0.5" }),
    /* @__PURE__ */ jsx44("rect", { x: "81", y: "55", width: "5", height: "5", fill: stroke, opacity: faint })
  ] });
}
function EmptySketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("ellipse", { cx: "60", cy: "56", rx: "26", ry: "5", fill: stroke, opacity: 0.14 }),
    /* @__PURE__ */ jsx44("rect", { x: "40", y: "28", width: "40", height: "24", rx: "4", stroke: accent, strokeWidth: "1.4", strokeDasharray: "4 3", fill: accent, fillOpacity: "0.06" }),
    /* @__PURE__ */ jsx44("line", { x1: "48", y1: "40", x2: "72", y2: "40", stroke, strokeWidth: "1.2", opacity: faint, strokeLinecap: "round" })
  ] });
}
function DescriptionsSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "22", y: "22", width: "76", height: "36", rx: "4", stroke, strokeWidth: "1.2", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "56", y1: "22", x2: "56", y2: "58", stroke, strokeWidth: "1", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "22", y1: "34", x2: "98", y2: "34", stroke, strokeWidth: "1", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "22", y1: "46", x2: "98", y2: "46", stroke, strokeWidth: "1", opacity: faint }),
    /* @__PURE__ */ jsx44("line", { x1: "28", y1: "28", x2: "48", y2: "28", stroke: accent, strokeWidth: "1.3", opacity: 0.6, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "28", y1: "40", x2: "48", y2: "40", stroke: accent, strokeWidth: "1.3", opacity: 0.6, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "62", y1: "28", x2: "90", y2: "28", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("line", { x1: "62", y1: "40", x2: "84", y2: "40", stroke, strokeWidth: "1.3", opacity: faint, strokeLinecap: "round" })
  ] });
}
function LoadingSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "40", r: "16", stroke, strokeWidth: "2.4", opacity: 0.2 }),
    /* @__PURE__ */ jsx44("path", { d: "M60 24 a16 16 0 0 1 16 16", stroke: accent, strokeWidth: "2.6", fill: "none", strokeLinecap: "round" })
  ] });
}
function FpsHistogramSketch() {
  const bars = [14, 22, 12, 28, 18, 24, 10, 20];
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    bars.map((h, i) => /* @__PURE__ */ jsx44("rect", { x: 26 + i * 9, y: 58 - h, width: "6", height: h, rx: "1.5", fill: accent, fillOpacity: i % 2 ? 0.3 : 0.55, stroke: accent, strokeWidth: "0.8" }, i)),
    /* @__PURE__ */ jsx44("line", { x1: "24", y1: "58", x2: "98", y2: "58", stroke, strokeWidth: "1.2", opacity: faint })
  ] });
}
function IconifySketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("circle", { cx: "60", cy: "40", r: "20", stroke: accent, strokeWidth: "1.5", fill: accent, fillOpacity: "0.08" }),
    /* @__PURE__ */ jsx44("circle", { cx: "53", cy: "36", r: "2.4", fill: accent }),
    /* @__PURE__ */ jsx44("circle", { cx: "67", cy: "36", r: "2.4", fill: accent }),
    /* @__PURE__ */ jsx44("path", { d: "M51 47 a10 8 0 0 0 18 0", stroke: accent, strokeWidth: "1.6", fill: "none", strokeLinecap: "round" })
  ] });
}
function LoginButtonSketch() {
  return /* @__PURE__ */ jsxs26(Fragment9, { children: [
    /* @__PURE__ */ jsx44("rect", { x: "22", y: "30", width: "56", height: "18", rx: "5", fill: accent, fillOpacity: "0.2", stroke: accent, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsx44("line", { x1: "30", y1: "39", x2: "58", y2: "39", stroke: accent, strokeWidth: "1.4", opacity: 0.6, strokeLinecap: "round" }),
    /* @__PURE__ */ jsx44("path", { d: "M82 33 l8 6 l-8 6 M74 39 l14 0", stroke: accent, strokeWidth: "1.6", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
var SKETCHES = {
  // Botones
...
function DemoSketch({ demoId }) {
  ...
  return /* @__PURE__ */ jsx44("svg", { className: "demo-sketch", viewBox: "0 0 120 80", "aria-hidden": true, fill: "none", children: /* @__PURE__ */ jsx44(Inner, {}) });
}
function CatalogCard({ demoId, displayLabel, status, item, onSelect }) {
  ...
  return /* @__PURE__ */ jsxs26("button", { type: "button", className: "catalog-card", onClick: handleSelect, title: `Abrir demo ${displayLabel}`, children: [
    /* @__PURE__ */ jsx44("div", { className: "catalog-card__preview", children: /* @__PURE__ */ jsx44(DemoSketch, { demoId }) }),
    /* @__PURE__ */ jsxs26("div", { className: "catalog-card__footer", children: [
      /* @__PURE__ */ jsx44("span", { className: "catalog-card__name", children: displayLabel }),
      status && /* @__PURE__ */ jsx44(ReviewStatusDot, { status, size: "0.5rem" })
    ] })
  ] });
}
function CatalogToc({ sections, counts, activeSection, onSectionClick }) {
  return /* @__PURE__ */ jsxs26("nav", { className: "catalog-toc", "aria-label": "En esta p\xE1gina", children: [
    /* @__PURE__ */ jsx44("p", { className: "catalog-toc__label", children: "En esta p\xE1gina" }),
    /* @__PURE__ */ jsx44("ul", { className: "catalog-toc__list", children: sections.map((sid) => /* @__PURE__ */ jsx44("li", { children: /* @__PURE__ */ jsxs26("a", { href: `#section-${sid}`, className: ["catalog-toc__link", activeSection === sid && "is-active"].filter(Boolean).join(" "), onClick: (e) => {
      e.preventDefault();
      onSectionClick?.(sid);
      document.getElementById(`section-${sid}`)?.scrollIntoView({ behavior: "smooth", block: "start" });
    }, children: [
      sectionLabel(sid),
      /* @__PURE__ */ jsx44("span", { className: "catalog-toc__count", children: counts[sid] ?? 0 })
    ] }) }, sid)) })
  ] });
}
function CatalogHome({
  ...
  return /* @__PURE__ */ jsxs26("div", { className: "catalog-overview", children: [
    !filterSection && visibleSections.length > 1 && /* @__PURE__ */ jsx44("aside", { className: "catalog-overview__toc", children: /* @__PURE__ */ jsx44(CatalogToc, { sections: visibleSections, counts, onSectionClick: () => {
    } }) }),
    /* @__PURE__ */ jsxs26("div", { className: "catalog-overview__main catalog-home", children: [
      showHero && /* @__PURE__ */ jsxs26("header", { className: "catalog-overview__hero pg-vt-hero", children: [
        /* @__PURE__ */ jsx44("p", { className: "catalog-home__kicker mimicus-ui-brand", children: overview.kicker ?? MIMICUS_UI.name }),
        /* @__PURE__ */ jsx44("h1", { className: "catalog-home__title", children: heroTitle }),
        /* @__PURE__ */ jsx44("p", { className: "catalog-home__lead", children: heroLead }),
        /* @__PURE__ */ jsxs26("div", { className: "catalog-overview__toolbar", children: [
          /* @__PURE__ */ jsxs26("label", { className: "catalog-search", children: [
            /* @__PURE__ */ jsx44(Icon, { icon: "mdi:magnify", className: "catalog-search__icon" }),
            /* @__PURE__ */ jsx44("input", { type: "search", className: "catalog-search__input", placeholder: "Buscar componente\u2026", value: query, onChange: (e) => setQuery(e.target.value), "aria-label": "Buscar componente" })
          ] }),
          onOpenPaletteLab && /* @__PURE__ */ jsxs26(Button, { variant: "outlined", color: "primary", onClick: onOpenPaletteLab, style: { width: "fit-content", flexShrink: 0 }, children: [
            /* @__PURE__ */ jsx44(Icon, { icon: "mdi:palette-swatch-outline" }),
            "Paleta & Look"
          ] })
        ] })
      ] }),
      !showHero && filterSection && /* @__PURE__ */ jsx44("header", { className: "catalog-overview__hero catalog-overview__hero--section pg-vt-hero pg-vt-category", children: /* @__PURE__ */ jsxs26("div", { className: "catalog-section-heading", children: [
        /* @__PURE__ */ jsx44(Icon, { icon: sectionIcon(filterSection), className: "catalog-section-heading__icon" }),
        /* @__PURE__ */ jsxs26("div", { children: [
          /* @__PURE__ */ jsx44("h1", { className: "catalog-home__title", children: heroTitle }),
          heroLead && /* @__PURE__ */ jsx44("p", { className: "catalog-home__lead", children: heroLead })
        ] })
      ] }) }),
      visibleSections.map((sid) => {
        const sectionItems = itemsInSection(filtered, sid);
        if (!sectionItems.length) return null;
        return /* @__PURE__ */ jsxs26("section", { id: `section-${sid}`, className: "catalog-section", "aria-labelledby": `heading-${sid}`, children: [
          !filterSection && /* @__PURE__ */ jsxs26("div", { className: "catalog-section-heading", id: `heading-${sid}`, children: [
            /* @__PURE__ */ jsx44("h2", { className: "catalog-section-heading__title", children: sectionLabel(sid) }),
            /* @__PURE__ */ jsx44(Badge2, { children: sectionItems.length })
          ] }),
          /* @__PURE__ */ jsx44("div", { className: "catalog-grid catalog-grid--overview", children: sectionItems.map((it) => /* @__PURE__ */ jsx44(CatalogCard, { demoId: it.id, displayLabel: it.displayLabel, item: it, status: statusFor(it.id, it), onSelect: () => onSelect?.(it.section, it.slug) }, `${it.section}/${it.slug}`)) })
        ] }, sid);
      }),
      filtered.length === 0 && /* @__PURE__ */ jsxs26("p", { className: "catalog-home__lead", children: [
...
function ThemeLab() {
  return /* @__PURE__ */ jsx44("div", { className: "catalog-home catalog-overview__main pg-vt-main", children: /* @__PURE__ */ jsxs26("header", { className: "catalog-overview__hero pg-vt-hero", children: [
    /* @__PURE__ */ jsx44("p", { className: "catalog-home__kicker mimicus-ui-brand", children: MIMICUS_UI.name }),
    /* @__PURE__ */ jsx44("h1", { className: "catalog-home__title", children: "Paleta & Look" }),
    /* @__PURE__ */ jsx44("p", { className: "catalog-home__lead", children: "Laboratorio visual de paletas, look & feel y luminancia. Usa los selectores del header para probar combinaciones en tiempo real." })
  ] }) });
}
...
function ConfigCard({ children, className }) {
  return /* @__PURE__ */ jsx45("div", { className: ["pg-demo-config-card", "card-root", className].filter(Boolean).join(" "), children });
}
function InputDecorated({ label, icon, asTitle, children, className }) {
  const Tag2 = asTitle ? "h3" : "label";
  return /* @__PURE__ */ jsxs27("div", { className: ["pg-input-decorated", asTitle && "pg-input-decorated--title", className].filter(Boolean).join(" "), children: [
    (label || icon) && /* @__PURE__ */ jsxs27(Tag2, { className: "pg-input-decorated__label", children: [
      icon && /* @__PURE__ */ jsx45("span", { className: "pg-input-decorated__icon", "aria-hidden": true, children: /* @__PURE__ */ jsx45("iconify-icon", { icon }) }),
      label
    ] }),
    /* @__PURE__ */ jsx45("div", { className: "pg-input-decorated__body", children })
  ] });
}
function PaletteGrid({ label, labelIcon, value, onValueChange, options, name, columns, accent: accent2 = "primary", layout = "chips", getIcon }) {
  ...
  if (layout === "chips") {
    return /* @__PURE__ */ jsx45(InputDecorated, { label, icon: labelIcon, children: /* @__PURE__ */ jsx45("div", { className: "pg-palette-chips", style: { display: "flex", flexWrap: "wrap", gap: "0.35rem" }, children: items.map(([lbl, val]) => {
      const selected = String(value ?? "") === String(val ?? "");
      const icon = getIcon ? getIcon(val) : void 0;
      return /* @__PURE__ */ jsxs27(Button, { type: "button", variant: selected ? "soft" : "text", color: accent2 === "semantic" && val ? val : "primary", shape: "pill", onClick: () => onValueChange?.(val === "" ? void 0 : val), style: { fontSize: "0.78rem", paddingBlock: "0.2rem", paddingInline: "0.7rem", minHeight: "1.7rem" }, children: [
        icon && /* @__PURE__ */ jsx45(Icon, { icon }),
        lbl || String(val ?? "Ninguno")
      ] }, `${groupName}-${String(val)}`);
    }) }) });
  }
  return /* @__PURE__ */ jsx45(InputDecorated, { label, icon: labelIcon, children: /* @__PURE__ */ jsx45("div", { className: "pg-palette-grid", style: { display: "grid", gridTemplateColumns: `repeat(${cols}, minmax(0, 1fr))`, gap: "0.35rem", width: "100%" }, children: items.map(([lbl, val]) => {
    const selected = String(value ?? "") === String(val ?? "");
    return /* @__PURE__ */ jsxs27("label", { className: "pg-palette-grid__item", style: { display: "flex", alignItems: "center", gap: "0.35rem", cursor: "pointer" }, children: [
      /* @__PURE__ */ jsx45("input", { type: "radio", name: groupName, checked: selected, onChange: () => onValueChange?.(val === "" ? void 0 : val) }),
      /* @__PURE__ */ jsx45("span", { children: lbl || String(val ?? "Ninguno") })
    ] }, `${groupName}-${String(val)}`);
  }) }) });
}
...
function SwitchRow({ checked, label, onChange }) {
  return /* @__PURE__ */ jsx45(Switch, { className: "pg-switch-row", size: "small", checked: !!checked, onChange: (v) => onChange?.(v), children: label });
}
function ConfigRangeField({ value, min = 0, max = 100, step = 1, onChange }) {
  ...
  return /* @__PURE__ */ jsxs27("div", { className: "mimicus-slider pg-config-range", style: { width: "100%" }, children: [
    /* @__PURE__ */ jsx45("div", { className: "mimicus-slider__rail", children: /* @__PURE__ */ jsx45("div", { className: "mimicus-slider__fill", style: { width: `${pct}%` } }) }),
    /* @__PURE__ */ jsx45("input", { type: "range", className: "mimicus-slider__input", min, max, step, value: num, onInput: handle, onChange: handle }),
    /* @__PURE__ */ jsx45("span", { className: "mimicus-slider__value", children: num })
  ] });
}
function IconTextField({ field, state: state2, patchState }) {
  const iconVal = state2[field.iconKey] ?? "";
  const textVal = state2[field.textKey] ?? "";
  return /* @__PURE__ */ jsx45(InputDecorated, { label: field.label, icon: field.labelIcon, children: /* @__PURE__ */ jsxs27("div", { style: { display: "grid", gap: "0.6rem" }, children: [
    /* @__PURE__ */ jsx45(
      PaletteGrid,
      {
        label: "\xCDcono",
    ...
    /* @__PURE__ */ jsxs27("label", { style: { display: "grid", gap: "0.3rem" }, children: [
      /* @__PURE__ */ jsx45("span", { style: { fontSize: "0.8rem", opacity: 0.85 }, children: "Texto" }),
      /* @__PURE__ */ jsx45(Input, { value: String(textVal), onChange: (v) => patchState(String(field.textKey), v), prefix: iconVal ? /* @__PURE__ */ jsx45(Icon, { icon: String(iconVal) }) : void 0 })
    ] })
  ] }) });
}
function ConfigCodeField({ value = "", onChange, placeholder, mode, lang, minHeight = "4.5rem", maxHeight = "8.5rem" }) {
  return /* @__PURE__ */ jsx45("div", { className: "code-edit-field", children: /* @__PURE__ */ jsx45(
    CodeBlock,
    {
...
function DemoConfigRenderer({ fields, state: state2, onStateChange }) {
  ...
  return typedFields.map((field) => {
    ...
    const wrap = (node) => /* @__PURE__ */ jsx45(ConfigCard, { children: node }, key);
    if (field.kind === "palette") {
      const opts = field.layout === "sideCross" || field.layout === "chips" ? field.options : withNoneOption(field.options);
      return wrap(/* @__PURE__ */ jsx45(PaletteGrid, { label: field.label, labelIcon: field.labelIcon, value: state2[field.key], onValueChange: (v) => patchState(String(field.key), v), options: opts, name: field.name ?? `pg-${String(field.key)}`, columns: field.columns, accent: field.accent ?? "primary", layout: field.layout ?? "chips", getIcon: field.getIcon ?? ((v) => defaultOptionIcon(field.key, v)) }));
    }
    if (field.kind === "color") {
      return wrap(/* @__PURE__ */ jsx45(PaletteGrid, { label: field.label, labelIcon: field.labelIcon, value: state2[field.key], onValueChange: (v) => patchState(String(field.key), v), options: colorOptions, name: `pg-color-${String(field.key)}`, layout: "chips", accent: "semantic", getIcon: (v) => COLOR_ICONS[String(v)] }));
    }
    if (field.kind === "switch") {
      return wrap(/* @__PURE__ */ jsx45(InputDecorated, { label: field.label, icon: field.labelIcon ?? "mdi:tune", children: /* @__PURE__ */ jsx45(SwitchRow, { checked: state2[field.key], label: field.label, onChange: (v) => patchState(String(field.key), v) }) }));
    }
    if (field.kind === "switch-group") {
      return wrap(
        /* @__PURE__ */ jsx45(InputDecorated, { label: field.label, icon: field.labelIcon, children: /* @__PURE__ */ jsx45("div", { style: { display: "flex", flexWrap: "wrap", gap: "0.75rem" }, children: field.switches.map((sw) => /* @__PURE__ */ jsx45(SwitchRow, { checked: state2[sw.key], label: sw.label, onChange: (v) => patchState(String(sw.key), v) }, String(sw.key))) }) })
      );
    }
    if (field.kind === "text") {
      if (field.normalize) {
        ...
        return wrap(
          /* @__PURE__ */ jsx45(InputDecorated, { label: field.label, icon: field.labelIcon, children: /* @__PURE__ */ jsx45(
            Input,
            {
      ...
      return wrap(
        /* @__PURE__ */ jsx45(InputDecorated, { label: field.label, icon: field.labelIcon, children: /* @__PURE__ */ jsx45(Input, { placeholder: field.placeholder, value: String(state2[field.key] ?? ""), onChange: (v) => patchState(String(field.key), v) }) })
      );
    }
    if (field.kind === "range") {
      return wrap(
        /* @__PURE__ */ jsx45(InputDecorated, { label: field.label, icon: field.labelIcon, children: /* @__PURE__ */ jsx45(ConfigRangeField, { value: state2[field.key], min: field.min, max: field.max, step: field.step, onChange: (v) => patchState(String(field.key), v) }) })
      );
    }
    if (field.kind === "number") {
      return wrap(
        /* @__PURE__ */ jsx45(InputDecorated, { label: field.label, icon: field.labelIcon, children: /* @__PURE__ */ jsx45(InputNumber, { min: field.min, max: field.max, step: field.step, value: Number(state2[field.key] ?? 0), onChange: (v) => patchState(String(field.key), v) }) })
      );
    }
    ...
    if (field.kind === "code") {
      ...
      return wrap(
        /* @__PURE__ */ jsx45(InputDecorated, { label: field.label, icon: field.labelIcon ?? "mdi:code-braces", children: /* @__PURE__ */ jsx45(
          ConfigCodeField,
          {
            value: String(state2[fkey] ?? ""),
    ...
    if (field.kind === "icon-text") {
      return wrap(/* @__PURE__ */ jsx45(IconTextField, { field, state: state2, patchState }));
    }
    return wrap(/* @__PURE__ */ jsxs27("p", { style: { margin: 0, fontSize: "0.85rem", opacity: 0.75 }, children: [
      "Campo \xAB",
      field.kind,
...
function ApiTable({ adapter }) {
  ...
  return /* @__PURE__ */ jsx45("div", { className: "pg-api-table-wrap", children: /* @__PURE__ */ jsxs27("table", { className: "pg-api-table", children: [
    /* @__PURE__ */ jsx45("thead", { children: /* @__PURE__ */ jsxs27("tr", { children: [
      /* @__PURE__ */ jsx45("th", { children: "Property" }),
      /* @__PURE__ */ jsx45("th", { children: "Description" }),
      /* @__PURE__ */ jsx45("th", { children: "Type" }),
      /* @__PURE__ */ jsx45("th", { children: "Default" })
    ] }) }),
    /* @__PURE__ */ jsx45("tbody", { children: rows.map((r) => /* @__PURE__ */ jsxs27("tr", { children: [
      /* @__PURE__ */ jsx45("td", { children: /* @__PURE__ */ jsx45("code", { className: "pg-api-table__prop", children: String(r.name) }) }),
      /* @__PURE__ */ jsx45("td", { children: r.desc ?? "\u2014" }),
      /* @__PURE__ */ jsx45("td", { children: /* @__PURE__ */ jsx45("code", { className: "pg-api-table__type", children: String(r.type) }) }),
      /* @__PURE__ */ jsx45("td", { children: /* @__PURE__ */ jsx45("code", { className: "pg-api-table__default", children: String(r.def) }) })
    ] }, String(r.name))) })
  ] }) });
}
function AccordionDemo({
  ...
  const [showCode, setShowCode] = useState13(false);
  const [previewResetKey, setPreviewResetKey] = useState13(0);
  ...
  return /* @__PURE__ */ jsxs27("article", { className: ["pg-demo-doc", "pg-vt-demo-morph", className].filter(Boolean).join(" "), children: [
    /* @__PURE__ */ jsxs27("header", { className: "pg-demo-doc__hero", children: [
      /* @__PURE__ */ jsxs27("div", { className: "pg-demo-doc__title-row", children: [
        titleIcon && /* @__PURE__ */ jsx45(Icon, { icon: titleIcon, className: "pg-demo-doc__icon" }),
        /* @__PURE__ */ jsx45("h1", { className: "pg-demo-doc__title", children: finalTitle }),
        reviewStatus && /* @__PURE__ */ jsx45(ReviewStatusDot, { status: reviewStatus, size: "0.62rem" })
      ] }),
      intro && /* @__PURE__ */ jsx45("div", { className: "pg-demo-doc__intro intro", dangerouslySetInnerHTML: { __html: intro } })
    ] }),
    preview && /* @__PURE__ */ jsxs27("section", { className: "pg-demo-doc__section", "aria-labelledby": `${demoId ?? finalTitle}-examples`, children: [
      /* @__PURE__ */ jsx45("h2", { className: "pg-demo-doc__section-title", id: `${demoId ?? finalTitle}-examples`, children: "Examples" }),
      /* @__PURE__ */ jsxs27("div", { className: "pg-demo-example", children: [
        /* @__PURE__ */ jsx45("div", { className: "pg-demo-example__preview preview-frame pg-vt-preview", children: /* @__PURE__ */ jsx45("div", { className: "preview-viewport", children: /* @__PURE__ */ jsx45("div", { className: "preview-scale-track", children: /* @__PURE__ */ jsx45("div", { className: "preview-stage", style: { ...previewStageStyle, ...scaleStyle }, "data-preview-key": previewKey, children: preview({ state: state2, details, demoConfig, previewKey, demoStyle, demoClass }) }) }) }) }),
        finalCodeStr && /* @__PURE__ */ jsxs27("div", { className: "pg-demo-example__toolbar", children: [
          /* @__PURE__ */ jsxs27(Button, { type: "button", variant: "text", color: "primary", onClick: () => setShowCode((v) => !v), children: [
            /* @__PURE__ */ jsx45(Icon, { icon: showCode ? "mdi:chevron-up" : "mdi:code-tags" }),
            showCode ? "Ocultar c\xF3digo" : "Ver c\xF3digo"
          ] }),
          /* @__PURE__ */ jsxs27(Button, { type: "button", variant: "text", color: "neutral", onClick: () => {
            try {
              navigator.clipboard?.writeText(finalCodeStr);
            } catch {
            }
          }, children: [
            /* @__PURE__ */ jsx45(Icon, { icon: "mdi:content-copy" }),
            "Copiar"
          ] })
        ] }),
        finalCodeStr && showCode && /* @__PURE__ */ jsx45(CodeBlock, { value: finalCodeStr, readOnly: true, lang: "jsx", minHeight: "7rem", maxHeight: "22rem", lineWrapping: true, className: "pg-demo-example__code" })
      ] })
    ] }),
    adapter && /* @__PURE__ */ jsxs27("section", { className: "pg-demo-doc__section pg-demo-doc__section--playground", "aria-labelledby": `${demoId ?? finalTitle}-playground`, children: [
      /* @__PURE__ */ jsx45("h2", { className: "pg-demo-doc__section-title", id: `${demoId ?? finalTitle}-playground`, children: "Playground" }),
      /* @__PURE__ */ jsxs27(ConfigCard, { className: "pg-demo-config-section demo-config-shell", children: [
        /* @__PURE__ */ jsxs27("div", { style: { display: "grid", gridTemplateColumns: `repeat(${configCols}, minmax(0, 1fr))`, gap: "0.75rem", width: "100%", alignItems: "start" }, children: [
          /* @__PURE__ */ jsx45(ConfigCard, { children: /* @__PURE__ */ jsx45(InputDecorated, { label: "style", icon: "mdi:palette-swatch-outline", children: /* @__PURE__ */ jsx45(ConfigCodeField, { value: demoStyle, onChange: (v) => onDemoStyleChange?.(v), placeholder: "inline style", mode: "css", minHeight: "4.5rem", maxHeight: "8.5rem" }) }) }),
          /* @__PURE__ */ jsx45(ConfigCard, { children: /* @__PURE__ */ jsx45(InputDecorated, { label: "className", icon: "mdi:code-braces", children: /* @__PURE__ */ jsx45(ConfigCodeField, { value: demoClass, onChange: (v) => onDemoClassChange?.(v), placeholder: "clases CSS", minHeight: "4.5rem", maxHeight: "8.5rem" }) }) }),
          /* @__PURE__ */ jsx45(DemoConfigRenderer, { fields: configFields, state: state2, onStateChange }),
          detailFields.length > 0 && /* @__PURE__ */ jsx45(DemoConfigRenderer, { fields: detailFields, state: details, onStateChange: onDetailsChange }),
          configExtra
        ] }),
        demoConfigFields.length > 0 && /* @__PURE__ */ jsx45("div", { style: { marginTop: "0.85rem" }, children: /* @__PURE__ */ jsx45(InputDecorated, { asTitle: true, label: "Config de demo", icon: "mdi:television-play", children: /* @__PURE__ */ jsx45(DemoConfigRenderer, { fields: demoConfigFields, state: demoConfig, onStateChange: onDemoConfigChange }) }) }),
        /* @__PURE__ */ jsx45("div", { style: { display: "flex", justifyContent: "flex-end", width: "100%", marginTop: "0.75rem" }, children: /* @__PURE__ */ jsxs27(Button, { type: "button", variant: "soft", color: "primary", onClick: handleReset, children: [
          /* @__PURE__ */ jsx45(Icon, { icon: "mdi:refresh" }),
          "Reiniciar valores"
        ] }) })
      ] })
    ] }),
    hasApi && /* @__PURE__ */ jsxs27("section", { className: "pg-demo-doc__section", "aria-labelledby": `${demoId ?? finalTitle}-api`, children: [
      /* @__PURE__ */ jsx45("h2", { className: "pg-demo-doc__section-title", id: `${demoId ?? finalTitle}-api`, children: "API" }),
      /* @__PURE__ */ jsx45(ApiTable, { adapter })
    ] })
  ] });
}
...
import { useEffect as useEffect18, useMemo as useMemo10, useState as useState14 } from "react";
...
function makeStub(name) {
  ...
  function StubComponent({ className, style, children, ...rest }) {
    ...
    return /* @__PURE__ */ jsxs28("div", { className: ["mimicus-preview-stub", className].filter(Boolean).join(" "), style, "data-component": name, children: [
      /* @__PURE__ */ jsxs28("div", { className: "mimicus-preview-stub__badge", children: [
        /* @__PURE__ */ jsx46(Icon, { icon: "mdi:package-variant" }),
        " ",
        label
      ] }),
      children && /* @__PURE__ */ jsx46("div", { className: "mimicus-preview-stub__body", children }),
      /* @__PURE__ */ jsx46("p", { className: "mimicus-preview-stub__hint", children: "Componente pendiente de port a React" })
    ] });
  }
...
function useNarrowViewport() {
  const [narrow, setNarrow] = useState14(false);
  useEffect18(() => {
...
function LayoutAppPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  ...
  const [siderCollapsed, setSiderCollapsed] = useState14(Boolean(state2.siderCollapsed));
  ...
  return /* @__PURE__ */ jsx47("div", { className: ["layout-app-preview", narrow && "layout-app-preview--drawer"].filter(Boolean).join(" "), children: /* @__PURE__ */ jsx47(AppLayoutProvider, { defaultSiderWidth: `${siderWidth}px`, children: /* @__PURE__ */ jsxs29(AppLayout, { variant, fixedHeader: Boolean(state2.fixedHeader), fixedSider: Boolean(state2.fixedSider), responsive: true, responsiveDrawer: narrow, style: shellStyle, className: demoClass, children: [
    /* @__PURE__ */ jsxs29(AppLayout.Header, { children: [
      /* @__PURE__ */ jsx47(AppLayout.Header.Brand, { children: /* @__PURE__ */ jsx47("span", { style: { fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.06em" }, children: String(details.brandLabel ?? "Brand") }) }),
      /* @__PURE__ */ jsx47(AppLayout.Header.Center, { children: /* @__PURE__ */ jsx47("span", { children: String(details.headerLabel ?? "Header") }) }),
      /* @__PURE__ */ jsx47(AppLayout.Header.Tools, { children: /* @__PURE__ */ jsx47("span", { style: { fontSize: "0.75rem", opacity: 0.85 }, children: String(details.toolsLabel ?? "Tools") }) })
    ] }),
    !narrow && /* @__PURE__ */ jsx47(AppLayout.Sider, { collapsed: siderCollapsed, collapsible: Boolean(state2.siderCollapsible), width: siderWidth, theme: state2.siderTheme === "light" ? "light" : "dark", onCollapse: setSiderCollapsed, children: /* @__PURE__ */ jsx47("span", { style: { fontSize: "0.8rem", fontWeight: 600 }, children: String(details.siderLabel ?? "Sider") }) }),
    /* @__PURE__ */ jsx47("div", { className: "pg-shell-main", style: { padding: "0.75rem", flex: "1 1 auto", minHeight: 0, overflow: "auto" }, children: String(details.contentLabel ?? "Content") }),
    /* @__PURE__ */ jsx47(AppLayout.Footer, { children: String(details.footerLabel ?? "Footer") })
  ] }) }) }, previewKey);
}
function CardPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  ...
  if (inline) {
    return /* @__PURE__ */ jsx47("div", { className: "card-inline-demo card-inline-demo--inline", children: /* @__PURE__ */ jsxs29("p", { className: "card-inline-flow", children: [
      CARD_INLINE_FLOW_BEFORE,
      /* @__PURE__ */ jsx47(Card, { inline: true, relieve: relievePacked, variant: cardPreviewVariant, style: cardStyle, className: demoClass, children: /* @__PURE__ */ jsx47("span", { style: { fontSize: "0.85rem", lineHeight: 1.35, whiteSpace: "nowrap" }, children: CARD_INLINE_SAMPLE_TEXT }) }),
      CARD_INLINE_FLOW_AFTER
    ] }) }, previewKey);
  }
  return /* @__PURE__ */ jsxs29("div", { className: "card-inline-demo", children: [
    /* @__PURE__ */ jsx47("p", { className: "card-block-lead", children: "En modo bloque, la tarjeta interrumpe el p\xE1rrafo y ocupa el ancho disponible." }),
    /* @__PURE__ */ jsx47(Card, { relieve: relievePacked, variant: cardPreviewVariant, style: cardStyle, className: demoClass, children: /* @__PURE__ */ jsxs29("div", { style: { display: "flex", gap: "0.65rem", width: "100%" }, children: [
      /* @__PURE__ */ jsx47(Icon, { icon: "mdi:text-box-outline", style: { fontSize: "1.25rem", flexShrink: 0, opacity: 0.88 } }),
      /* @__PURE__ */ jsx47("span", { style: { fontSize: "0.9rem", lineHeight: 1.45 }, children: CARD_PREVIEW_SAMPLE_TEXT })
    ] }) })
  ] }, previewKey);
}
function DividerPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  ...
  const showTitle = Boolean(details.showTitle) && String(details.title ?? "").trim();
  return /* @__PURE__ */ jsx47(BlockLayout, { children: orientation === "vertical" ? /* @__PURE__ */ jsxs29(FlexLayout, { items: "center", gap: "0.35rem", wrap: true, style: parseStyleString(shellStyle), className: demoClass, children: [
    /* @__PURE__ */ jsx47("span", { style: { color: resolveColor("primary") }, children: "Inicio" }),
    /* @__PURE__ */ jsx47(Divider, { ...dividerProps }),
    /* @__PURE__ */ jsx47("span", { children: "Cat\xE1logo" }),
    /* @__PURE__ */ jsx47(Divider, { ...dividerProps, variant: variant === "solid" ? "dotted" : variant }),
    /* @__PURE__ */ jsx47("span", { children: "Layouts" }),
    /* @__PURE__ */ jsx47(Divider, { ...dividerProps }),
    /* @__PURE__ */ jsx47(Card, { variant: "flat", inline: true, style: { border: `1px solid ${resolveColor("neutral")}` }, children: "Demo" })
  ] }) : /* @__PURE__ */ jsxs29(FlexLayout, { direction: "column", gap: "0.35rem", style: parseStyleString(shellStyle), className: demoClass, children: [
    /* @__PURE__ */ jsx47("span", { style: { fontSize: "0.85rem", opacity: 0.9 }, children: "Bloque superior con contenido de ejemplo antes del separador." }),
    /* @__PURE__ */ jsx47(Divider, { ...dividerProps, children: showTitle ? String(details.title) : null }),
    /* @__PURE__ */ jsx47("span", { style: { fontSize: "0.85rem", opacity: 0.9 }, children: "Bloque inferior: el divider respeta size, variant y titlePlacement." }),
    /* @__PURE__ */ jsx47(Divider, { ...dividerProps }),
    /* @__PURE__ */ jsx47(Card, { variant: "flat", style: { border: `1px solid ${resolveColor("neutral")}`, padding: "0.5rem" }, children: "Contenido tras l\xEDnea simple" })
  ] }) }, previewKey);
}
function SplitterPreview({ state: state2, demoConfig, previewKey, demoStyle, demoClass }) {
  ...
  const Pane = ({ title, count, cells, offset = 0 }) => /* @__PURE__ */ jsxs29("div", { style: { padding: "0.5rem", height: "100%", boxSizing: "border-box" }, children: [
    /* @__PURE__ */ jsx47("div", { style: { fontSize: "0.75rem", fontWeight: 600, marginBottom: "0.35rem", opacity: 0.85 }, children: title }),
    /* @__PURE__ */ jsx47(GridLayout, { cells: String(cells), gap: "0.35rem", children: Array.from({ length: count }, (_, i) => /* @__PURE__ */ jsx47(Card, { variant: "flat", inline: true, style: { padding: "0.35rem", textAlign: "center", minHeight: "2rem" }, children: LAYOUT_PREVIEW_EMOJIS[(i + offset) % LAYOUT_PREVIEW_EMOJIS.length] }, i)) })
  ] });
  const Surround = inline ? "span" : "div";
  return /* @__PURE__ */ jsx47(Surround, { className: inline ? "layout-inline-demo layout-inline-demo--inline" : "layout-inline-demo", children: /* @__PURE__ */ jsx47(Splitter, { inline, direction, panelSize: Math.round(Number(state2.panelSize)) || 240, minSize: Math.round(Number(state2.minSize)) || 160, maxSize: Math.round(Number(state2.maxSize)) || 480, responsive: false, className: demoClass, style: parseStyleString(shellStyle), panel: /* @__PURE__ */ jsx47(Pane, { title: "Panel", count: panelCount, cells: demoConfig?.panelCells ?? 1 }), children: /* @__PURE__ */ jsx47(Pane, { title: "Contenido", count: mainCount, cells: demoConfig?.mainCells ?? 2, offset: panelCount }) }) }, previewKey);
}
...
function AnchorPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  ...
  return /* @__PURE__ */ jsxs29("div", { className: ["mimicus-anchor-demo", direction === "horizontal" && "mimicus-anchor-demo--horizontal", "mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: [
    /* @__PURE__ */ jsx47(Anchor, { direction, affix: Boolean(state2.affix), targetOffset: Math.round(Number(state2.targetOffset)) || 0, bounds: Math.round(Number(state2.bounds)) || 5, container: containerSel, items: links }),
    /* @__PURE__ */ jsx47("div", { id: SCROLL_ID, "data-mimicus-anchor-container": true, className: "mimicus-anchor-demo__scroll", children: links.map((l, i) => /* @__PURE__ */ jsxs29("section", { id: l.href.slice(1), className: "mimicus-anchor-demo__section", children: [
      /* @__PURE__ */ jsx47("strong", { children: l.title }),
      /* @__PURE__ */ jsxs29("p", { style: { margin: "0.35rem 0 0", fontSize: "0.85rem", opacity: 0.85 }, children: [
...
function TabsPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  ...
  const items = Array.from({ length: count }, (_, i) => ({ key: `t${i + 1}`, label: `Tab ${i + 1}`, content: /* @__PURE__ */ jsxs29(Card, { variant: "flat", style: { padding: "0.65rem" }, children: [
    "Panel ",
    i + 1
  ] }) }));
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Tabs, { type: state2.type === "card" ? "card" : "line", tabPosition: state2.tabPosition ?? "top", defaultActiveKey: items[0].key, items }) }, previewKey);
}
function BreadcrumbsPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  ...
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Breadcrumbs, { separator: state2.separator ?? "/", maxItems: state2.maxItems ? Math.round(Number(state2.maxItems)) : void 0, items }) }, previewKey);
}
function DropdownPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Dropdown, { placement: state2.placement ?? "bottomLeft", trigger: /* @__PURE__ */ jsx47(Button, { variant: "solid", children: "Men\xFA \u25BE" }), menu: /* @__PURE__ */ jsxs29(Menu, { children: [
    /* @__PURE__ */ jsx47(Menu.Item, { itemKey: "1", children: "Perfil" }),
    /* @__PURE__ */ jsx47(Menu.Item, { itemKey: "2", children: "Ajustes" }),
    /* @__PURE__ */ jsx47(Menu.Divider, {}),
    /* @__PURE__ */ jsx47(Menu.Item, { itemKey: "3", children: "Salir" })
  ] }) }) }, previewKey);
}
function MenuPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsxs29(Menu, { mode: state2.mode === "horizontal" ? "horizontal" : "vertical", selectable: true, children: [
    /* @__PURE__ */ jsx47(Menu.Item, { itemKey: "home", children: "Inicio" }),
    /* @__PURE__ */ jsx47(Menu.Item, { itemKey: "docs", children: "Documentaci\xF3n" }),
    /* @__PURE__ */ jsx47(Menu.Divider, {}),
    /* @__PURE__ */ jsx47(Menu.Item, { itemKey: "about", children: "Acerca de" })
  ] }) }, previewKey);
}
function PaginationPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Pagination, { count: Math.round(Number(state2.count)) || 10, defaultPage: Math.round(Number(state2.defaultPage)) || 1, size: state2.size === "small" ? "small" : void 0, siblingCount: Math.round(Number(state2.siblingCount)) || 1 }) }, previewKey);
}
function StepsPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  ...
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Steps, { current, direction: state2.direction === "vertical" ? "vertical" : "horizontal", clickable: Boolean(state2.clickable), items: [
...
function DrawerPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  const [open, setOpen] = useState14(Boolean(state2.defaultOpen));
  useEffect18(() => {
    setOpen(Boolean(state2.defaultOpen));
  }, [state2.defaultOpen]);
  return /* @__PURE__ */ jsxs29("div", { className: ["mimicus-drawer-preview", "mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: [
    /* @__PURE__ */ jsx47(Button, { variant: "solid", onClick: () => setOpen(true), children: "Abrir drawer" }),
    /* @__PURE__ */ jsx47(Drawer, { open, placement: state2.placement ?? "left", width: Math.round(Number(state2.width)) || 280, title: "Panel lateral", onClose: () => setOpen(false), children: /* @__PURE__ */ jsx47("p", { style: { margin: 0, fontSize: "0.9rem" }, children: "Contenido del drawer. Clic fuera o Escape para cerrar (controlador vanilla)." }) })
  ] }, previewKey);
}
function BottomNavPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  ...
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(BottomNavigation, { value: state2.value ?? "0", showLabels: state2.showLabels !== false, children: Array.from({ length: n }, (_, i) => /* @__PURE__ */ jsx47(BottomNavigationAction, { value: String(i), label: labels[i], icon: /* @__PURE__ */ jsx47("span", { children: icons[i] }) }, i)) }) }, previewKey);
}
function LinkPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsxs29("p", { children: [
    "Ejemplo de ",
    /* @__PURE__ */ jsx47(NavLink, { href: "#", underline: state2.underline ?? "hover", color: state2.color ?? "primary", children: "enlace tem\xE1tico" }),
    " en un p\xE1rrafo."
  ] }) }, previewKey);
}
function SpeedDialPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-nav-preview", demoClass].filter(Boolean).join(" "), style: { ...parseStyleString(demoStyle), minHeight: "10rem", display: "flex", alignItems: "flex-end", justifyContent: "flex-end", padding: "1rem" }, children: /* @__PURE__ */ jsxs29(SpeedDial, { direction: state2.direction ?? "up", ariaLabel: "Acciones r\xE1pidas", children: [
    /* @__PURE__ */ jsx47(SpeedDialAction, { actionKey: "copy", icon: "\u{1F4CB}", tooltip: "Copiar" }),
    /* @__PURE__ */ jsx47(SpeedDialAction, { actionKey: "save", icon: "\u{1F4BE}", tooltip: "Guardar" }),
    /* @__PURE__ */ jsx47(SpeedDialAction, { actionKey: "share", icon: "\u2197", tooltip: "Compartir" })
  ] }) }, previewKey);
}
...
function SwitchPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Switch, { checked: state2.checked, disabled: state2.disabled, loading: state2.loading, children: details.label ?? "Texto de demostraci\xF3n" }) }, previewKey);
}
function CheckboxIconPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(
    CheckboxIcon,
    {
      ...
      iconChecked: /* @__PURE__ */ jsx47(Icon, { icon: String(details.previewIconTrue ?? "mdi:check") }),
      iconUnchecked: /* @__PURE__ */ jsx47(Icon, { icon: String(details.previewIconFalse ?? "mdi:close") }),
...
function CheckboxChipPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(CheckboxChip, { value: state2.color ?? "primary", options: CHIP_OPTIONS }) }, previewKey);
}
function LabeledSwitchPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(LabeledSwitch, { label: state2.label ?? "Publicar en cat\xE1logo", checked: state2.checked, readonly: state2.readonly }) }, previewKey);
}
...
function InputPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(FormItem, { label: "Campo de texto", children: /* @__PURE__ */ jsx47(Input, { size: state2.size ?? "medium", disabled: state2.disabled, allowClear: Boolean(state2.allowClear), placeholder: details.placeholder ?? "Escribe aqu\xED\u2026", status: state2.status }) }) }, previewKey);
}
function AutoCompletePreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(AutoComplete, { options: DEMO_AUTOCOMPLETE, disabled: state2.disabled, placeholder: "Buscar framework\u2026" }) }, previewKey);
}
function SelectPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Select, { size: state2.size, disabled: state2.disabled, placeholder: "Elige una opci\xF3n", options: DEMO_AUTOCOMPLETE, defaultValue: "react" }) }, previewKey);
}
function SliderPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Slider, { defaultValue: Math.round(Number(state2.defaultValue)) || 40, min: 0, max: 100, disabled: state2.disabled, showValue: true }) }, previewKey);
}
function RatePreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Rate, { defaultValue: 2.5, allowHalf: Boolean(state2.allowHalf), disabled: state2.disabled, size: state2.size }) }, previewKey);
}
function RadioPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(RadioGroup, { direction: state2.direction ?? "horizontal", defaultValue: "a", options: [{ value: "a", label: "Opci\xF3n A" }, { value: "b", label: "Opci\xF3n B" }, { value: "c", label: "Opci\xF3n C", disabled: state2.disabled }] }) }, previewKey);
}
function CheckboxPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Checkbox, { defaultChecked: true, indeterminate: Boolean(state2.indeterminate), disabled: state2.disabled, children: "Acepto t\xE9rminos" }) }, previewKey);
}
function InputNumberPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(InputNumber, { defaultValue: 3, min: 0, max: 10, step: 1, disabled: state2.disabled }) }, previewKey);
}
function TransferPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Transfer, { dataSource: DEMO_TRANSFER, targetKeys: ["2"], disabled: state2.disabled }) }, previewKey);
}
function UploadPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Upload, { multiple: Boolean(state2.multiple), disabled: state2.disabled }) }, previewKey);
}
function ColorPickerPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(ColorPicker, { defaultValue: state2.defaultValue ?? "#1677ff", disabled: state2.disabled }) }, previewKey);
}
function DatePickerPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(DatePicker, { disabled: state2.disabled }) }, previewKey);
}
function TimePickerPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(TimePicker, { disabled: state2.disabled }) }, previewKey);
}
function CascaderPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Cascader, { options: DEMO_CASCADER, disabled: state2.disabled, placeholder: "Ciudad" }) }, previewKey);
}
function TreeSelectPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(TreeSelect, { treeData: DEMO_TREE, disabled: state2.disabled, placeholder: "Componente" }) }, previewKey);
}
function MentionsPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Mentions, { options: [{ value: "paty", label: "Paty" }, { value: "mimicus", label: "Mimicus" }], disabled: state2.disabled }) }, previewKey);
}
function ToggleButtonPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsxs29(ToggleButtonGroup, { exclusive: state2.exclusive !== false, orientation: state2.orientation ?? "horizontal", defaultValue: "web", children: [
    /* @__PURE__ */ jsx47(ToggleButton, { value: "web", children: "Web" }),
    /* @__PURE__ */ jsx47(ToggleButton, { value: "android", children: "Android" }),
    /* @__PURE__ */ jsx47(ToggleButton, { value: "ios", children: "iOS" })
  ] }) }, previewKey);
}
function FormPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-form-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsxs29(Form, { layout: state2.layout ?? "vertical", children: [
    /* @__PURE__ */ jsx47(FormItem, { label: "Nombre", required: true, children: /* @__PURE__ */ jsx47(Input, { placeholder: "Tu nombre" }) }),
    /* @__PURE__ */ jsx47(FormItem, { label: "Framework", children: /* @__PURE__ */ jsx47(Select, { options: DEMO_AUTOCOMPLETE, defaultValue: "react" }) }),
    /* @__PURE__ */ jsx47(FormItem, { label: "Notas", children: /* @__PURE__ */ jsx47(TextArea, { rows: 2, placeholder: details.placeholder ?? "Comentarios" }) }),
    /* @__PURE__ */ jsx47(Button, { variant: "solid", type: "submit", children: "Enviar" })
  ] }) }, previewKey);
}
...
function BadgePreview({ state: state2, previewKey, demoStyle, demoClass }) {
  ...
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Badge, { count: state2.dot ? void 0 : count, dot: Boolean(state2.dot), showZero: Boolean(state2.showZero), max: Math.round(Number(state2.max)) || 99, color: state2.color ?? "primary", children: /* @__PURE__ */ jsx47(Button, { variant: "ghost", children: /* @__PURE__ */ jsx47(Icon, { icon: "mdi:bell-outline" }) }) }) }, previewKey);
}
function TagPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Tag, { variant: state2.variant ?? "ghost", shape: state2.shape ?? "pill", uppercase: Boolean(state2.upper), color: state2.color, icon: details.icon ? /* @__PURE__ */ jsx47(Icon, { icon: String(details.icon) }) : void 0, children: details.text ?? "Nuevo" }) }, previewKey);
}
function AvatarPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: state2.group ? /* @__PURE__ */ jsxs29(AvatarGroup, { max: Math.round(Number(state2.max)) || 4, children: [
    /* @__PURE__ */ jsx47(Avatar, { alt: "Ana", children: "A" }),
    /* @__PURE__ */ jsx47(Avatar, { alt: "Luis", children: "L" }),
    /* @__PURE__ */ jsx47(Avatar, { alt: "Sof\xEDa", children: "S" }),
    /* @__PURE__ */ jsx47(Avatar, { alt: "Mar\xEDa", children: "M" }),
    /* @__PURE__ */ jsx47(Avatar, { alt: "Pedro", children: "P" })
  ] }) : /* @__PURE__ */ jsx47(Avatar, { size: state2.size ?? "medium", variant: state2.variant ?? "circular", alt: "Remy Sharp", children: state2.withImage ? void 0 : "RS" }) }, previewKey);
}
function CarouselPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  const slides = ["#1", "#2", "#3", "#4"].map((n, i) => /* @__PURE__ */ jsx47(Card, { variant: "flat", style: { minHeight: "7rem", display: "flex", alignItems: "center", justifyContent: "center", background: `hsl(${i * 70} 45% 35%)` }, children: n }, i));
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(mergeStyleString("max-width: 24rem", demoStyle)), children: /* @__PURE__ */ jsx47(Carousel, { autoplay: Boolean(state2.autoplay), arrows: Boolean(state2.arrows), dots: state2.dots !== false, infinite: state2.infinite !== false, children: slides }) }, previewKey);
}
function CollapsePreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(mergeStyleString("max-width: 28rem", demoStyle)), children: /* @__PURE__ */ jsxs29(Collapse, { accordion: Boolean(state2.accordion), defaultActiveKey: state2.accordion ? "1" : ["1"], children: [
    /* @__PURE__ */ jsx47(CollapsePanel, { panelKey: "1", header: "Panel 1", defaultOpen: true, children: "Contenido del primer panel." }),
    /* @__PURE__ */ jsx47(CollapsePanel, { panelKey: "2", header: "Panel 2", children: "Segundo panel colapsable." }),
    /* @__PURE__ */ jsx47(CollapsePanel, { panelKey: "3", header: "Panel 3", children: "Tercer panel de ejemplo." })
  ] }) }, previewKey);
}
function DescriptionsPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsxs29(Descriptions, { title: "Usuario", bordered: Boolean(state2.bordered), column: Math.round(Number(state2.column)) || 3, children: [
    /* @__PURE__ */ jsx47(DescriptionsItem, { label: "Nombre", children: "Patricia" }),
    /* @__PURE__ */ jsx47(DescriptionsItem, { label: "Tel\xE9fono", children: "+57 300 000 0000" }),
    /* @__PURE__ */ jsx47(DescriptionsItem, { label: "Ciudad", children: "Bogot\xE1" }),
    /* @__PURE__ */ jsx47(DescriptionsItem, { label: "Rol", span: 2, children: "Administrador" })
  ] }) }, previewKey);
}
function EmptyPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Empty, { description: state2.description ?? "No data", image: state2.image ?? "default", children: state2.showAction && /* @__PURE__ */ jsx47(Button, { variant: "solid", size: "small", children: "Crear" }) }) }, previewKey);
}
function QRCodePreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(QRCode, { value: details.value ?? "https://mimicus.dev", size: Math.round(Number(state2.size)) || 128, bordered: state2.bordered !== false }) }, previewKey);
}
function SegmentedPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Segmented, { block: Boolean(state2.block), defaultValue: "list", options: [{ value: "list", label: "Lista" }, { value: "kanban", label: "Kanban" }, { value: "grid", label: "Grid" }] }) }, previewKey);
}
function StatisticPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Statistic, { title: state2.title ?? "Balance", value: state2.value ?? 112893, prefix: state2.prefix ?? "$", precision: state2.precision != null ? Math.round(Number(state2.precision)) : void 0, suffix: state2.suffix }) }, previewKey);
}
function TablePreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Table, { columns: DEMO_TABLE_COLS, dataSource: DEMO_TABLE_DATA, bordered: Boolean(state2.bordered), size: state2.size ?? "medium", sortable: Boolean(state2.sortable) }) }, previewKey);
}
function TimelinePreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsxs29(Timeline, { mode: state2.mode ?? "left", pending: state2.pending ? "Cargando\u2026" : void 0, children: [
    /* @__PURE__ */ jsx47(TimelineItem, { label: "2024-01", color: "success", children: "Cuenta creada" }),
    /* @__PURE__ */ jsx47(TimelineItem, { label: "2024-03", children: "Primer login" }),
    /* @__PURE__ */ jsx47(TimelineItem, { label: "2024-06", color: "error", children: "Intento fallido" })
  ] }) }, previewKey);
}
function TooltipPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(mergeStyleString("padding: 1.5rem", demoStyle)), children: /* @__PURE__ */ jsx47(Tooltip, { title: state2.title ?? "Texto de ayuda", placement: state2.placement ?? "top", arrow: Boolean(state2.arrow), children: /* @__PURE__ */ jsx47(Button, { variant: "solid", children: "Hover me" }) }) }, previewKey);
}
function TourPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsxs29("div", { className: ["mimicus-display-preview mimicus-tour-demo", demoClass].filter(Boolean).join(" "), style: parseStyleString(mergeStyleString("min-height: 10rem; position: relative", demoStyle)), children: [
    /* @__PURE__ */ jsx47(Button, { variant: "ghost", "data-tour-a": true, id: "tour-a", children: "Paso 1" }),
    /* @__PURE__ */ jsx47(Button, { variant: "ghost", "data-tour-b": true, id: "tour-b", style: { marginLeft: "0.5rem" }, children: "Paso 2" }),
    /* @__PURE__ */ jsx47(Tour, { open: Boolean(state2.open), steps: [{ target: "#tour-a", title: "Bienvenida", description: "Primer paso del tour." }, { target: "#tour-b", title: "Siguiente", description: "Segundo objetivo." }] })
  ] }, previewKey);
}
function TreePreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Tree, { treeData: DEMO_DISPLAY_TREE, checkable: Boolean(state2.checkable), defaultExpandAll: state2.defaultExpandAll !== false }) }, previewKey);
}
function CalendarPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(Calendar, { fullscreen: Boolean(state2.fullscreen) }) }, previewKey);
}
function ListPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(mergeStyleString("max-width: 22rem", demoStyle)), children: /* @__PURE__ */ jsxs29(List, { dense: Boolean(state2.dense), subheader: state2.subheader ? "Carpetas" : void 0, children: [
    /* @__PURE__ */ jsxs29(ListItem, { button: true, children: [
      /* @__PURE__ */ jsx47(ListItemAvatar, { children: /* @__PURE__ */ jsx47(Avatar, { alt: "F", children: "F" }) }),
      /* @__PURE__ */ jsx47(ListItemText, { primary: "Fotos", secondary: "Ene 9, 2024" })
    ] }),
    /* @__PURE__ */ jsxs29(ListItem, { button: true, children: [
      /* @__PURE__ */ jsx47(ListItemAvatar, { children: /* @__PURE__ */ jsx47(Avatar, { alt: "W", children: "W" }) }),
      /* @__PURE__ */ jsx47(ListItemText, { primary: "Trabajo", secondary: "Ene 7, 2024" })
    ] }),
    /* @__PURE__ */ jsx47(ListItem, { button: true, secondaryAction: /* @__PURE__ */ jsx47(Icon, { icon: "mdi:chevron-right" }), children: /* @__PURE__ */ jsx47(ListItemText, { primary: "Vacaciones", secondary: "Jul 20, 2024" }) })
  ] }) }, previewKey);
}
function CodeBlockPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(demoStyle), children: /* @__PURE__ */ jsx47(CodeBlock, { value: state2.code ?? details.code ?? "", readOnly: true, minHeight: state2.minHeight ?? "7rem", maxHeight: "18rem", lang: "jsx", lineWrapping: true }) }, previewKey);
}
function SidePanelPreview({ state: state2, details, previewKey, demoStyle, demoClass }) {
  const [open, setOpen] = useState14(state2.open !== false);
  const drawer = Boolean(state2.drawer);
  useEffect18(() => {
  ...
  const railView = /* @__PURE__ */ jsx47(SidePanel.View, { mode: "rail", gap: "0.35rem", children: sections.map((s) => /* @__PURE__ */ jsx47(Button, { variant: "text", shape: "rect", color: s.color, className: "pg-panel-rail__btn", title: s.label, style: { width: "100%", justifyContent: "center", minHeight: "2.35rem", paddingInline: "0.25rem" }, children: /* @__PURE__ */ jsx47(Icon, { icon: s.icon, style: { fontSize: "1.2rem" } }) }, s.id)) });
  const expandedView = /* @__PURE__ */ jsx47(SidePanel.View, { mode: "expanded", gap: "0.25rem", children: sections.map((s, i) => /* @__PURE__ */ jsx47(SidePanelSection, { icon: s.icon, label: s.label, color: s.color, open: i === 0, count: s.count, onToggle: () => {
  }, onHeaderClick: () => {
  }, children: Array.from({ length: 2 }, (_, j) => /* @__PURE__ */ jsxs29(Button, { variant: "text", shape: "rect", color: s.color, style: { justifyContent: "flex-start", fontSize: "0.85rem", width: "100%" }, children: [
    /* @__PURE__ */ jsx47(Icon, { icon: "mdi:file-document-outline" }),
    /* @__PURE__ */ jsxs29("span", { className: "sm-item-text", children: [
      "Demo ",
      j + 1
    ] })
  ] }, j)) }, s.id)) });
  ...
  return /* @__PURE__ */ jsx47("div", { className: ["layout-side-panel-preview", demoClass].filter(Boolean).join(" "), style: shellStyle, children: /* @__PURE__ */ jsx47(SidePanel, { open, drawer, onToggle: drawer ? void 0 : () => setOpen((v) => !v), onClose: drawer ? () => {
...
function LoginButtonPreview({ previewKey, demoStyle, demoClass }) {
  ...
  return /* @__PURE__ */ jsx47(ContapymeSessionProvider, { session, children: /* @__PURE__ */ jsx47("div", { className: ["mimicus-login-button-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(mergeStyleString("width:100%;padding:0.65rem 0.75rem;border:1px solid var(--mimicus-b-color);border-radius:var(--mimicus-ui-radius,0.5rem);background:color-mix(in srgb,var(--mimicus-bg-secondary),transparent 8%)", demoStyle)), children: /* @__PURE__ */ jsxs29(FlexLayout, { items: "center", justify: "flex-end", gap: "0.5rem", children: [
    /* @__PURE__ */ jsx47("span", { style: { fontSize: "0.78rem", opacity: 0.75, marginRight: "auto" }, children: "AppLayout.Header.Tools" }),
    /* @__PURE__ */ jsx47(LoginButton, { showPasswordToggle: true, showRemember: true })
  ] }) }, previewKey) });
}
...
function DataGridPreview({ state: state2, previewKey, demoStyle, demoClass }) {
  ...
  return /* @__PURE__ */ jsx47("div", { className: ["mimicus-display-preview", demoClass].filter(Boolean).join(" "), style: parseStyleString(mergeStyleString("width:100%", demoStyle)), children: /* @__PURE__ */ jsx47(
    DataGrid,
    {
      columns: DG_COLUMNS,
      rows,
...
function PreviewStub({ template, componentName }) {
  return /* @__PURE__ */ jsxs29("div", { className: "mimicus-preview-stub mimicus-preview-stub--template", children: [
    /* @__PURE__ */ jsxs29("div", { className: "mimicus-preview-stub__badge", children: [
      /* @__PURE__ */ jsx47(Icon, { icon: "mdi:television-play" }),
      " Vista \xAB",
      template,
      "\xBB"
    ] }),
    /* @__PURE__ */ jsxs29("p", { className: "mimicus-preview-stub__hint", children: [
      "Preview ",
      /* @__PURE__ */ jsx47("strong", { children: componentName ?? template }),
      " sin plantilla JSON."
    ] })
  ] });
}
function buildDemoComponentProps(node, ctx) {
  ...
  let children;
  if (node.iconFromDetails && details[node.iconFromDetails]) props.icon = /* @__PURE__ */ jsx47(Icon, { icon: String(details[node.iconFromDetails]) });
...
import { Fragment as Fragment10, jsx as jsx48, jsxs as jsxs30 } from "react/jsx-runtime";
...
function CatalogCategories({ node, ctx }) {
  ...
  if (mode === "rail") {
    return categories.map((cat) => {
      ...
      const meta = sectionMeta(ctx, cat);
      return /* @__PURE__ */ jsx48(Button, { variant: active ? "soft" : "text", shape: "rect", color, "data-section-color": color, className: "pg-panel-rail__btn", title: meta.label ?? cat, onClick: () => ctx.onCategory?.(cat), style: { width: "100%", justifyContent: "center", minHeight: "2.35rem", paddingInline: "0.25rem" }, children: /* @__PURE__ */ jsx48(Icon, { icon: meta.icon ?? "mdi:folder-outline", style: { fontSize: "1.2rem" } }) }, cat);
    });
  }
  ...
  return categories.map((cat) => {
    ...
    return /* @__PURE__ */ jsx48(SidePanelSection, { icon: meta.icon ?? "mdi:folder-outline", label: meta.label ?? cat, color, open: sectionOpen?.[cat], collapsed: false, active: route.category === cat && !route.slug, forceOpen: route.category === cat && !!route.slug, count: items.length, statusDots: statusDotsFor(items.map((it) => it.id)), onToggle: () => setSectionOpen?.((prev) => ({ ...prev, [cat]: !prev[cat] })), onHeaderClick: () => ctx.onCategory?.(cat), children: items.map((it) => {
      const selected = route.category === cat && route.slug === it.slug;
      return /* @__PURE__ */ jsxs30(Button, { variant: selected ? "soft" : "text", shape: "rect", color, onClick: () => ctx.onDemo?.(cat, it.slug), className: "pg-panel-demo-link", title: it.displayLabel, style: { justifyContent: "flex-start", fontSize: "0.85rem", width: "100%" }, children: [
        /* @__PURE__ */ jsx48(Icon, { icon: getDemoIcon(it.id, it) }),
        /* @__PURE__ */ jsxs30("span", { className: "sm-item-label", children: [
          /* @__PURE__ */ jsx48("span", { className: "sm-item-text", children: it.displayLabel }),
          statusFor(it.id, it) && /* @__PURE__ */ jsx48(ReviewStatusDot, { status: statusFor(it.id, it), size: "0.48rem" })
        ] })
      ] }, it.slug);
    }) }, cat);
  });
...
function PlaygroundJsonPanel({ node, ctx }) {
  return /* @__PURE__ */ jsx48(JsonRenderer, { node, ctx });
}
function JsonRenderer({ node, ctx, keyPrefix = "" }) {
  if (!node) return null;
  if (node.type === "builtin") {
    const Builtin = previewBuiltins[node.id];
    return Builtin ? /* @__PURE__ */ jsx48(Builtin, { ...ctx }) : null;
  }
  if (node.type === "wrap") {
    return /* @__PURE__ */ jsx48("div", { style: parseStyleString(node.style), children: /* @__PURE__ */ jsx48(JsonRenderer, { node: node.child, ctx, keyPrefix: `${keyPrefix}-w` }) }, keyPrefix);
  }
  if (node.type === "surround") {
    const inline = Boolean(ctx.state?.[node.inlineFromState ?? "inline"]);
    const Tag2 = inline ? "span" : "div";
    return /* @__PURE__ */ jsx48(Tag2, { className: inline ? "layout-inline-demo layout-inline-demo--inline" : "layout-inline-demo", children: /* @__PURE__ */ jsx48(JsonRenderer, { node: node.child, ctx, keyPrefix: `${keyPrefix}-s` }) }, keyPrefix);
  }
  if (node.type === "repeat") {
    const count = readCount(ctx, node);
    return Array.from({ length: count }, (_, i) => /* @__PURE__ */ jsx48(JsonRenderer, { node: node.child, ctx: { ...ctx, repeatIndex: i }, keyPrefix: `${keyPrefix}-r${i}` }, `${keyPrefix}-r${i}`));
  }
  if (node.type === "emoji-card") {
    ...
    return /* @__PURE__ */ jsx48(Card, { variant: "flat", inline: node.inline !== false, style: parseStyleString(node.cardStyle), children: node.labelPrefix ? label : emoji }, keyPrefix);
  }
  if (node.type === "demo-component") {
    ...
    const inner = node.children ? /* @__PURE__ */ jsx48(JsonRenderer, { node: node.children, ctx }) : children;
    return /* @__PURE__ */ jsx48(Comp, { ...props, style, children: inner });
  }
  if (node.type === "stack") {
    const rendered = (node.children ?? []).flatMap((child, idx) => {
      ...
      if (child.type === "separator") return [/* @__PURE__ */ jsx48("hr", { className: "sidebar-separator" }, `sep-${idx}`)];
      return [/* @__PURE__ */ jsx48(JsonRenderer, { node: child, ctx, keyPrefix: `${keyPrefix}-${idx}` }, child.id || idx)];
    });
    return /* @__PURE__ */ jsx48("div", { className: node.className, style: stackStyle(node.gap), children: rendered });
  }
  if (node.type === "catalog-categories") {
    const out = CatalogCategories({ node, ctx });
    return Array.isArray(out) ? /* @__PURE__ */ jsx48(Fragment10, { children: out }) : out;
  }
  return null;
}
...
function PreviewRenderer(props) {
  ...
  if (node?.type === "builtin") {
    const Builtin = previewBuiltins[node.id];
    return Builtin ? /* @__PURE__ */ jsx49(Builtin, { ...props }) : /* @__PURE__ */ jsx49(PreviewStub, { template: node.id, componentName: definition.component?.name });
  }
  const rendered = /* @__PURE__ */ jsx49(JsonRenderer, { node, ctx });
  if (rendered) return rendered;
  return /* @__PURE__ */ jsx49(PreviewStub, { template: definition.preview?.template, componentName: definition.component?.name });
}
...
function DemoPage({ definition }) {
  ...
  const [state2, setState] = useState15(() => adapter.initialState());
  const [details, setDetails] = useState15(() => adapter.initialDetails());
  const [demoConfig, setDemoConfig] = useState15(() => adapter.initialDemoConfig());
  const [demoStyle, setDemoStyle] = useState15("");
  const [demoClass, setDemoClass] = useState15("");
  ...
  return /* @__PURE__ */ jsx50(
    AccordionDemo,
    {
      ...
      preview: (ctx) => /* @__PURE__ */ jsx50("div", { className: "demo-preview-root", children: /* @__PURE__ */ jsx50(PreviewRenderer, { definition, ...ctx }) })
    }
  );
}
...
import { useCallback as useCallback3, useEffect as useEffect19, useState as useState16 } from "react";
...
function PlaygroundBrand({ title, icon = "assets/mimicus-logo.svg", onClick }) {
  ...
  return /* @__PURE__ */ jsxs31(
    Tag2,
    {
      ...
      children: [
        /* @__PURE__ */ jsx51("img", { src: icon, alt: "", width: "22", height: "22", className: "pg-app-brand__icon" }),
        /* @__PURE__ */ jsx51("span", { className: "pg-app-brand__title", children: title })
      ]
    }
  );
}
...
function FpsCounter({ collapsed = false }) {
  const [fps, setFps] = useState16(60);
  useEffect19(() => {
    let frames = 0;
  ...
  return /* @__PURE__ */ jsxs32("span", { className: "fps-histogram-chip", title: "FPS \xB7 \xFAltimo segundo", children: [
    /* @__PURE__ */ jsx52("span", { className: "fps-histogram-chip__value", children: fps }),
    !collapsed && /* @__PURE__ */ jsx52("span", { className: "fps-histogram-chip__unit", children: "FPS" })
  ] });
}
function PlaygroundSkinSelect({ label, value, options, onChange, accent: accent2 = "palette" }) {
  ...
  return /* @__PURE__ */ jsx52("div", { className: ["pg-skin-toggle", accent2 === "palette" ? "pg-skin-toggle--palette" : "pg-skin-toggle--look"].join(" "), ...dataProps, title: label, children: /* @__PURE__ */ jsx52("select", { className: "pg-skin-toggle__select", value, onChange: (e) => onChange?.(e.target.value), "aria-label": label, children: options.map((o) => /* @__PURE__ */ jsx52("option", { value: o.id, children: o.label }, o.id)) }) });
}
function HeaderSkinBar() {
  const [theme, setTheme] = useState16(() => getThemeState());
  const [look, setLook] = useState16(() => getLooknfeelState());
  const [layout, setLayout] = useState16(() => getPlaygroundAppLayoutVariant());
  useEffect19(() => subscribeTheme(setTheme), []);
  useEffect19(() => subscribeLooknfeel(setLook), []);
  useEffect19(() => subscribePlaygroundAppLayoutVariant(setLayout), []);
  return /* @__PURE__ */ jsxs32("div", { className: "pg-header-skin-bar", children: [
    /* @__PURE__ */ jsx52(PlaygroundSkinSelect, { label: "Layout", accent: "look", value: layout, options: PLAYGROUND_LAYOUT_SELECT_OPTIONS, onChange: setPlaygroundAppLayoutVariant }),
    /* @__PURE__ */ jsx52(PlaygroundSkinSelect, { label: "Paleta", accent: "palette", value: theme.themeColor, options: THEME_COLOR_OPTIONS, onChange: setThemeColor }),
    /* @__PURE__ */ jsx52(PlaygroundSkinSelect, { label: "Look n feel", accent: "look", value: look, options: LOOKNFEEL_OPTIONS, onChange: applyLooknfeel }),
    /* @__PURE__ */ jsx52(Button, { variant: theme.luminance === "dark" ? "soft" : "text", color: "neutral", shape: "rect", className: "pg-header-skin-bar__theme-btn", onClick: () => setLuminance(theme.luminance === "dark" ? "light" : "dark"), title: theme.luminance === "dark" ? "Modo claro" : "Modo oscuro", style: { width: "auto", minWidth: "2rem", flexShrink: 0 }, children: /* @__PURE__ */ jsx52("span", { "aria-hidden": true, children: theme.luminance === "dark" ? "\u2600" : "\u263E" }) })
  ] });
}
function PlaygroundShellHeader({
  ...
  const center = headerCenter ?? (title ? /* @__PURE__ */ jsx52("span", { className: "title pg-route-title pg-shell-route-title pg-vt-header", children: title }) : null);
  const tools = headerTools ?? headerEnd;
  const nav = shellNavigation ?? /* @__PURE__ */ jsxs32(Fragment11, { children: [
    primaryNav,
    secondaryNav
  ] });
  return /* @__PURE__ */ jsxs32(AppLayout.Header, { barClassName: "pg-shell-toolbar", className: "pg-shell-header-stack pg-content-header", children: [
    /* @__PURE__ */ jsxs32(AppLayout.Header.Brand, { children: [
      showShellMenuBtn && /* @__PURE__ */ jsx52(Button, { variant: "text", shape: "rect", color: "neutral", onClick: onShellMenuClick, className: "sidebar-header-btn pg-shell-menu-btn", title: menuTitle, style: { flexShrink: 0, width: "auto" }, children: /* @__PURE__ */ jsx52(Icon, { icon: "mdi:menu" }) }),
      brandTitle && /* @__PURE__ */ jsx52(PlaygroundBrand, { title: brandTitle, onClick: onBrandClick })
    ] }),
    /* @__PURE__ */ jsx52(AppLayout.Header.Center, { children: center }),
    /* @__PURE__ */ jsx52(AppLayout.Header.Tools, { children: tools }),
    nav ? /* @__PURE__ */ jsx52(AppLayout.Header.Nav, { children: nav }) : null
  ] });
}
function PlaygroundAppShell({
  ...
  const [variant, setVariant] = useState16(() => getPlaygroundAppLayoutVariant());
  const storageKey = panelStorageKey();
  usePlaygroundBodyScrollLock(true);
  useEffect19(() => subscribePlaygroundAppLayoutVariant(setVariant), []);
  useEffect19(() => {
    try {
  ...
  const shellHeader = /* @__PURE__ */ jsx52(
  ...
  if (embedMode) {
    return /* @__PURE__ */ jsx52("div", { className: shellClass, style: shellStyle, children: /* @__PURE__ */ jsxs32("div", { className: "pg-shell-stage pg-shell-stage--embed", children: [
      /* @__PURE__ */ jsxs32(AppLayout.Header, { className: "pg-content-header", children: [
        /* @__PURE__ */ jsx52(AppLayout.Header.Center, { children: title && /* @__PURE__ */ jsx52("span", { className: "title pg-route-title", children: title }) }),
        /* @__PURE__ */ jsx52(AppLayout.Header.Tools, { children: headerEnd })
      ] }),
      /* @__PURE__ */ jsx52("div", { className: "pg-shell-main custom-scrollbar pg-scrollbar", children })
    ] }) });
  }
  return /* @__PURE__ */ jsxs32("div", { className: shellClass, style: shellStyle, children: [
    useDrawer && drawerOpen && /* @__PURE__ */ jsx52("button", { type: "button", className: "pg-shell-drawer-backdrop", "aria-label": "Cerrar men\xFA", onClick: closeDrawer }),
    useDrawer && /* @__PURE__ */ jsx52("div", { className: ["pg-shell-drawer-panel", panelEnd ? "pg-shell-drawer-panel--right" : "pg-shell-drawer-panel--left", drawerOpen && "is-open"].filter(Boolean).join(" "), "aria-hidden": !drawerOpen, children: /* @__PURE__ */ jsx52(SidePanel, { open: true, drawer: true, collapsedView: collapsedPanel, expandedView: expandedPanel, onClose: closeDrawer }) }),
    shellHeader,
    /* @__PURE__ */ jsxs32(
      AppLayout,
      {
        ...
        children: [
          showSider && !useDrawer && /* @__PURE__ */ jsx52(AppLayout.Sider, { children: /* @__PURE__ */ jsx52(SidePanel, { open, onToggle: toggleSidebar, collapsedView: collapsedPanel, expandedView: expandedPanel }) }),
          /* @__PURE__ */ jsx52("div", { className: "pg-shell-main custom-scrollbar pg-scrollbar pg-vt-main", children })
        ]
      },
      gridVariant
    )
...
// src/devkit/Playground.tsx
import { Fragment as Fragment12, jsx as jsx53, jsxs as jsxs33 } from "react/jsx-runtime";
function Playground({ catalog = [], catalogMeta, sectionsMeta, shellConfig: shellConfigProp, previewTemplates, brand }) {
  ...
  const [navState, setNavState] = useState17(() => urlState.get());
  const route = useMemo12(() => stateToRoute(navState), [navState]);
  const [sectionOpen, setSectionOpen] = useState17(() => Object.fromEntries(implementedSections.map((s) => [s, true])));
  useEffect20(() => {
  ...
  const collapsedPanel = /* @__PURE__ */ jsx53(PlaygroundJsonPanel, { node: cfg.views?.collapsed, ctx: panelCtx });
  const expandedPanel = /* @__PURE__ */ jsx53(PlaygroundJsonPanel, { node: cfg.views?.expanded, ctx: panelCtx });
  return /* @__PURE__ */ jsxs33(
    PlaygroundAppShell,
    {
      brandTitle: MIMICUS_UI.name,
      onBrandClick: () => setNav(null),
      headerCenter: routeTitle ? /* @__PURE__ */ jsx53("span", { className: "title pg-route-title pg-shell-route-title pg-vt-header", children: routeTitle }) : null,
      headerTools: /* @__PURE__ */ jsxs33(Fragment12, { children: [
        /* @__PURE__ */ jsx53(FpsCounter, {}),
        /* @__PURE__ */ jsx53(HeaderSkinBar, {})
      ] }),
      shellNavigation: /* @__PURE__ */ jsx53(ShellHeaderNav, { shellConfig: cfg, ctx: panelCtx, onTab: (id) => dispatchShellNav(id, panelCtx, cfg) }),
      collapsedPanel,
      expandedPanel,
      embedMode,
      children: [
        isPaletteLabView && /* @__PURE__ */ jsx53(ThemeLab, {}),
        isCatalogView && /* @__PURE__ */ jsx53(
          CatalogHome,
          {
        ...
        isSectionView && route.category && /* @__PURE__ */ jsx53(
          CatalogHome,
          {
        ...
        !isPaletteLabView && !isCatalogView && !isSectionView && /* @__PURE__ */ jsxs33("div", { className: "pg-vt-demo pg-demo-doc-page", children: [
          filteredItems.map((it) => /* @__PURE__ */ jsx53(DemoPage, { definition: it.definition }, `${it.section}/${it.slug}`)),
          filteredItems.length === 0 && /* @__PURE__ */ jsx53("p", { className: "catalog-home__lead", children: "No hay demos para esta ruta." })
        ] })
      ]
    }
  );
