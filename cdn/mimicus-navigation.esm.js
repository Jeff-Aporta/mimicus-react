...
function AnchorLink({ href, title, children, className, ...rest }) {
  return /* @__PURE__ */ jsx("a", { ...rest, href, title, className: cx("mimicus-anchor__link", className), "data-mimicus-anchor-link": true, children: /* @__PURE__ */ jsx("span", { className: "mimicus-anchor__link-title", children: children ?? title }) });
}
