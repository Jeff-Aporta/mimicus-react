...
(() => {
  ...
  function Tour({ steps = [], open = false, className, style, ...rest }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { ...rest, ref, className: cx("mimicus-tour", open && "is-active", className), style, "data-mimicus-display": "tour", "data-open": open, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "mimicus-tour__overlay", "data-mimicus-tour-overlay": true, hidden: true }),
  ...
  function StatusDot({ color, size = "0.48rem" }) {
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "mimicus-side-panel-section__status-dot", style: { width: size, height: size, borderRadius: "50%", background: resolveColor(color), display: "inline-block", flexShrink: 0 }, "aria-hidden": true });
  }
  ...
  function SidePanelSection({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: ["mimicus-side-panel-section", "sm-section", collapsed && "is-collapsed", open && !collapsed && "is-open", active && "is-active"].filter(Boolean).join(" "), style: accentStyle, "data-section-color": color, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", alignItems: "stretch", gap: "0.1rem", width: "100%" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Button, { variant: active ? "soft" : "text", shape: "rect", color, onClick: onHeaderClick, style: { flex: "1 1 auto", minWidth: 0, justifyContent: collapsed ? "center" : "flex-start", fontSize: "0.78rem", fontWeight: 600 }, title: typeof label === "string" ? label : void 0, children: [
          ...
          !collapsed && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "sm-title-group", children: [
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "sm-label", children: label }),
              statusDotsUnique.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "sm-status-dots", children: statusDotsUnique.map((dotColor) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(StatusDot, { color: dotColor }, dotColor)) })
            ] }),
  ...
  function FormItem({ label, required, help, error, children, className, layout = "vertical", ...rest }) {
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("label", { ...rest, className: cx4("mimicus-form-item", `mimicus-form-item--${layout}`, error && "has-error", className), children: [
      label && /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("span", { className: "mimicus-form-item__label", children: [
        label,
        required && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-form-item__req", children: "*" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-form-item__control", children }),
      (help || error) && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-form-item__extra", children: error ?? help })
    ] });
  }
  function Form({ layout = "vertical", className, style, children, ...rest }) {
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("form", { ...rest, className: cx4("mimicus-form", `mimicus-form--${layout}`, className), style, onSubmit: (e) => e.preventDefault(), children });
  }
  Form.Item = FormItem;
  function Input({
    value,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("span", { className: cx4("mimicus-input", `mimicus-input--${size}`, status && `is-${status}`, disabled && "is-disabled", className), style, children: [
      ...
      allowClear && val && !disabled && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("button", { type: "button", className: "mimicus-input__clear", "aria-label": "Limpiar", onClick: () => set(""), children: "\xD7" }),
      suffix && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-input__affix mimicus-input__suffix", children: suffix })
    ] });
  }
  var TextField = Input;
  ...
  function InputNumber({ value, defaultValue = 0, onChange, min, max, step = 1, size = "medium", disabled, className, style, ...rest }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
      "span",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("button", { type: "button", className: "mimicus-input-number__btn", "data-mimicus-input-number-dec": true, disabled, tabIndex: -1, children: "\u2212" }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
            "input",
            {
              ...rest,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("button", { type: "button", className: "mimicus-input-number__btn", "data-mimicus-input-number-inc": true, disabled, tabIndex: -1, children: "+" })
        ]
      }
    );
  }
  function Checkbox({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("label", { className: cx4("mimicus-checkbox", `mimicus-checkbox--${size}`, on2 && "is-checked", indeterminate && "is-indeterminate", disabled && "is-disabled", loading && "is-loading", className), style, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-checkbox__box", "aria-hidden": true }),
  ...
  function LabeledSwitch({ label, checked, defaultChecked, onChange, readonly, ...rest }) {
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(FormItem, { label, layout: "horizontal", className: "mimicus-labeled-switch", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Switch, { checked, defaultChecked, onChange, disabled: readonly, ...rest }) });
  }
  function Radio({ value, checked, defaultChecked, onChange, disabled, children, className, name, ...rest }) {
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("label", { className: cx4("mimicus-radio", checked && "is-checked", disabled && "is-disabled", className), children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        "input",
        {
          ...rest,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-radio__dot", "aria-hidden": true }),
      children != null && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-radio__label", children })
    ] });
  }
  ...
  function Slider({ value, defaultValue = 0, onChange, min = 0, max = 100, step = 1, disabled, vertical, className, style, showValue, ...rest }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "mimicus-slider__rail", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "mimicus-slider__fill", "data-mimicus-slider-fill": true }) }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
            "input",
            {
              type: "range",
          ...
          showValue && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-slider__value", "data-mimicus-slider-value": true, children: val })
        ]
      }
    );
  }
  function Rate({ value, defaultValue = 0, onChange, count = 5, allowHalf, allowClear = true, disabled, character = "\u2605", size = "medium", className, style, ...rest }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
      "div",
      {
        ...
        children: Array.from({ length: count }, (_, i) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("button", { type: "button", className: "mimicus-rate__star", "data-mimicus-rate-star": i + 1, disabled, "aria-label": `${i + 1} estrellas`, children: character }, i))
      }
    );
  }
  var Rating = Rate;
  ...
  function AutoComplete({ options = [], value, defaultValue, onChange, onSelect, placeholder, disabled, className, style, ...rest }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { ref, className: cx4("mimicus-autocomplete", disabled && "is-disabled", className), style, "data-mimicus-form": "autocomplete", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Input, { ...rest, value: val, onChange: set, placeholder, disabled }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "mimicus-autocomplete__panel", "data-mimicus-autocomplete-panel": true, role: "listbox", hidden: true, children: options.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        "button",
        {
          type: "button",
          role: "option",
  ...
  function ToggleButton({ value, selected, onChange, disabled, children, icon, className, ...rest }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
      "button",
      {
        ...
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-toggle-btn__icon", "aria-hidden": true, children: icon }),
          children
        ]
      }
    );
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
      "div",
      {
        ...
        children: import_react20.Children.map(children, (child) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(ToggleButton, { ...node.props, selected: active, onChange: () => {
            if (exclusive) set(v);
            else {
  ...
  function Transfer({ dataSource, targetKeys, onChange, titles = ["Origen", "Destino"], disabled, className, style }) {
    ...
    const Item = ({ item }) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("li", { className: "mimicus-transfer__item", "data-mimicus-transfer-item": true, "data-key": item.key, children: item.title });
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
      "div",
      {
        ref,
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "mimicus-transfer__panel", children: [
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "mimicus-transfer__title", children: titles[0] }),
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("ul", { className: "mimicus-transfer__list", "data-mimicus-transfer-left": true, children: left.map((item) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Item, { item }, item.key)) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "mimicus-transfer__actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("button", { type: "button", className: "mimicus-transfer__action", "data-mimicus-transfer-action": "toRight", children: "\u203A" }),
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("button", { type: "button", className: "mimicus-transfer__action", "data-mimicus-transfer-action": "toLeft", children: "\u2039" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "mimicus-transfer__panel", children: [
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "mimicus-transfer__title", children: titles[1] }),
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("ul", { className: "mimicus-transfer__list", "data-mimicus-transfer-right": true, children: right.map((item) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Item, { item }, item.key)) })
          ] })
        ]
      }
    );
  ...
  function TransferBoard({ stackCount = 3, stackWidth = 248, disabled, itemsPerStack = 3, className, style }) {
    ...
    const stacks = Array.from({ length: stackCount }, (_, s) => /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: "mimicus-transfer-board__stack", "data-mimicus-transfer-stack": true, style: { width: stackWidth }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("ul", { className: "mimicus-transfer-board__list", "data-mimicus-transfer-list": true, children: Array.from({ length: itemsPerStack }, (_2, i) => /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("li", { className: "mimicus-transfer-board__card", "data-mimicus-transfer-item": true, draggable: !disabled, children: [
        "Tarjeta ",
        s * itemsPerStack + i + 1
      ] }, i)) })
    ] }, s));
  ...
  function Upload({ accept, multiple, disabled, children, className, style, ...rest }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { ref, className: cx4("mimicus-upload", disabled && "is-disabled", className), style, "data-mimicus-form": "upload", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("label", { className: "mimicus-upload__trigger", children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("input", { ...rest, type: "file", className: "mimicus-upload__native", accept, multiple, disabled }),
        children ?? /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-upload__btn", children: "Subir archivo" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("ul", { className: "mimicus-upload__list", "data-mimicus-upload-list": true })
    ] });
  }
  function ColorPicker({ value = "#1677ff", defaultValue, onChange, disabled, className, style, ...rest }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-color-picker__swatch", "data-mimicus-color-swatch": true, style: { background: val } }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("input", { ...rest, type: "color", value: val, disabled, onChange: (e) => set(e.target.value) }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("code", { className: "mimicus-color-picker__hex", "data-mimicus-color-hex": true, children: val })
        ]
      }
    );
  }
  function DatePicker({ value, defaultValue, onChange, disabled, className, style, ...rest }) {
    const [val, set] = useCtrl(value, defaultValue ?? "", onChange);
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Input, { ...rest, type: "date", className: cx4("mimicus-date-picker", className), style, value: val, disabled, onChange: set });
  }
  ...
  function Cascader({ options = [], value, onChange, placeholder = "Seleccionar", disabled, className, style }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { ref, className: cx4("mimicus-cascader", disabled && "is-disabled", className), style, "data-value": value, "data-mimicus-form": "cascader", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("button", { type: "button", className: "mimicus-cascader__trigger", "data-mimicus-cascader-trigger": true, disabled, children: placeholder }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "mimicus-cascader__panel", "data-mimicus-cascader-panel": true, hidden: true, children: flat.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        "button",
        {
          type: "button",
  ...
  function TreeSelect({ treeData = [], value, onChange, placeholder = "Seleccionar", disabled, className, style }) {
    ...
    const Node = ({ node, depth = 0 }) => /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("li", { className: "mimicus-tree-select__node", "data-mimicus-tree-node": true, "data-value": node.value, "data-label": node.title, style: { paddingLeft: `${depth * 0.75}rem` }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "mimicus-tree-select__label", children: node.title }),
      node.children?.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("ul", { className: "mimicus-tree-select__children", "data-mimicus-tree-children": true, hidden: true, children: node.children.map((c) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Node, { node: c, depth: depth + 1 }, c.value ?? c.title)) })
    ] });
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { ref, className: cx4("mimicus-tree-select", disabled && "is-disabled", className), style, "data-value": value, "data-mimicus-form": "tree-select", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("button", { type: "button", className: "mimicus-tree-select__trigger", "data-mimicus-tree-trigger": true, disabled, children: placeholder }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "mimicus-tree-select__panel", "data-mimicus-tree-panel": true, hidden: true, children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("ul", { className: "mimicus-tree-select__tree", children: treeData.map((n) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Node, { node: n }, n.value ?? n.title)) }) })
    ] });
  }
  function Mentions({ options = [], value, defaultValue, onChange, rows = 3, placeholder, disabled, className, style, ...rest }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { ref, className: cx4("mimicus-mentions", disabled && "is-disabled", className), style, "data-mimicus-form": "mentions", children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(TextArea, { ...rest, rows, value: val, onChange: set, placeholder: placeholder ?? "Escribe @ para mencionar", disabled }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "mimicus-mentions__panel", "data-mimicus-mentions-panel": true, hidden: true, children: options.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("button", { type: "button", className: "mimicus-mentions__option", "data-mimicus-mentions-option": true, "data-value": opt.value ?? opt, children: [
        "@",
        opt.label ?? opt
      ] }, opt.value ?? opt)) })
    ] });
  ...
  function GridHeader(props) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "mim-dg__header", style: { width: totalWidth, height: headerHeight }, role: "row", children: [
      selectionMode !== "none" && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "mim-dg__cell mim-dg__cell--check mim-dg__head-cell is-pinned is-pinned-left", style: checkPinStyle, role: "columnheader", children: selectionMode === "multiple" && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("button", { type: "button", className: `mim-dg__checkbox mim-dg__checkbox--${headerCheckbox}`, "aria-label": "Seleccionar todo", onClick: onToggleAll, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Icon, { icon: headerCheckbox === "all" ? "mdi:checkbox-marked" : headerCheckbox === "some" ? "mdi:minus-box" : "mdi:checkbox-blank-outline" }) }) }),
      columns.map((col) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "mim-dg__head-label", children: col.headerName }),
              filteredCols.has(col.colId) && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Icon, { icon: "mdi:filter", className: "mim-dg__filter-icon" }),
              dir && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Icon, { icon: sortIcon[dir], className: "mim-dg__sort-icon" }),
              dir && sortModel.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "mim-dg__sort-order", children: idx + 1 }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Icon, { icon: "mdi:dots-vertical" })
                }
              ),
              col.resizable && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "mim-dg__resizer", onPointerDown: startResize(col), role: "separator", "aria-orientation": "vertical" })
            ]
          },
          col.colId
        );
  ...
  function GridCell({ column, node, pinStyle }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "mim-dg__cell-inner", children: content })
      }
    );
  }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "mim-dg__body", style: { height: totalHeight, width: totalWidth }, role: "rowgroup", children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "mim-dg__rows", style: { transform: `translateY(${topPad}px)` }, children: rows.map((node) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
        "div",
        {
          ...
          children: [
            selectionMode !== "none" && /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "mim-dg__cell mim-dg__cell--check is-pinned is-pinned-left", style: checkPinStyle, role: "gridcell", children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("span", { className: `mim-dg__checkbox mim-dg__checkbox--${selected ? "all" : "none"}`, children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(Icon, { icon: selected ? "mdi:checkbox-marked" : "mdi:checkbox-blank-outline" }) }) }),
            columns.map((col) => /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(GridCell, { column: col, node, pinStyle: pinStyles[col.colId] }, col.colId))
          ]
        },
        node.id
      );
  ...
  function GridFooter(props) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "mim-dg__footer", role: "row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("span", { className: "mim-dg__count", children: [
        from.toLocaleString(),
        "\u2013",
        to.toLocaleString(),
        " de ",
        totalRows.toLocaleString(),
        selectedCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("span", { className: "mim-dg__count-sel", children: [
          " \xB7 ",
          selectedCount.toLocaleString(),
          " seleccionadas"
        ] })
      ] }),
      pagination && /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "mim-dg__pager", children: [
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("button", { type: "button", className: "mim-dg__pager-btn", disabled: page <= 0, "aria-label": "Anterior", onClick: () => onPage(page - 1), children: /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(Icon, { icon: "mdi:chevron-left" }) }),
        range.items.map((it) => it.type === "ellipsis" ? /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("span", { className: "mim-dg__pager-gap", children: "\u2026" }, it.key) : /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("button", { type: "button", className: `mim-dg__pager-btn${it.page === page + 1 ? " is-active" : ""}`, onClick: () => onPage(it.page - 1), children: it.page }, it.key)),
        /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("button", { type: "button", className: "mim-dg__pager-btn", disabled: page >= pageCount - 1, "aria-label": "Siguiente", onClick: () => onPage(page + 1), children: /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(Icon, { icon: "mdi:chevron-right" }) })
      ] })
    ] });
  }
  ...
  function GridToolbar(props) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "mim-dg__toolbar", role: "toolbar", children: [
      showQuickFilter && /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("label", { className: "mim-dg__quick", children: [
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(Icon, { icon: "mdi:magnify", className: "mim-dg__quick-icon" }),
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("input", { type: "search", className: "mim-dg__quick-input", placeholder: "Buscar\u2026", value: quickFilter, onChange: (e) => onQuickFilter(e.target.value) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { className: "mim-dg__toolbar-spacer" }),
      showDensity && /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { className: "mim-dg__density", role: "group", "aria-label": "Densidad", children: DENSITIES.map((d) => /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("button", { type: "button", className: `mim-dg__density-btn${density === d.key ? " is-active" : ""}`, title: d.label, "aria-label": d.label, "aria-pressed": density === d.key, onClick: () => onDensity(d.key), children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(Icon, { icon: d.icon }) }, d.key)) }),
      showExport && /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("button", { type: "button", className: "mim-dg__tool-btn", onClick: onExport, children: [
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(Icon, { icon: "mdi:file-delimited-outline" }),
        "Exportar CSV"
      ] })
    ] });
  }
