...
const {
  ...
  SpaRouter, SpaNavLink, JagSidebar, SpaOutlet,
  setLuminance, setThemeColor, applyLooknfeel,
  THEME_COLOR_OPTIONS, LOOKNFEEL_OPTIONS, getThemeState, subscribeTheme, getLooknfeelState, subscribeLooknfeel,
} = J;
...
function ThemeBar() {
  ...
  React.useEffect(() => subscribeLooknfeel(setLook), []);
...
function HomePage() {
  return (
    <Card style={{ margin: "1rem" }}>
      <h2 style={{ marginTop: 0 }}>jagudeloe-react-ui</h2>
      <p>UI React temática consumible por CDN. Contrato en <code>&lt;html data-luminance data-theme-color data-design-scheme data-looknfeel&gt;</code>.</p>
    ...
    <ThemeProvider>
      <AppLayoutProvider>
        <SpaRouter routes={ROUTES} defaultRoute="home">
          <div className="jagu-shell">
            <AppLayout variant="side" fixedHeader fixedSider responsive className="jagu-shell" style={{ minHeight: "100dvh" }}>
              <AppLayout.Header>
                <ThemeBar />
              </AppLayout.Header>
              <AppLayout.Sider>
                <AppLayoutSider theme="dark">
                  <JagSidebar title="Jagu UI">
              ...
              <div className="jagu-shell-main pg-shell-main">
